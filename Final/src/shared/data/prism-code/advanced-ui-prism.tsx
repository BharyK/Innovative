...
<p className="mb-0">
      <SpkButton onClick={() => setOpenb(!openb)} aria-controls="example-collapse-text" aria-expanded={open}
        href="#collapseExample" className="btn btn-primary collapsed mb-2 me-1" role="button">
          Link with href</SpkButton>
      <SpkButton  onClick={() => setOpenb(!openb)} aria-controls="example-collapse-text" aria-expanded={open}
        variant='' className="btn btn-secondary collapsed mb-2" type="button">
          Button with data-bs-target</SpkButton>
      </p> 
      <Collapse in={openb}>
...
export const carouseldata1 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
`;
export const carouseldata2 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<Carousel id="carouselExampleSlidesOnly" 
      ...
      `;
export const carouseldata3 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<Carousel id="carouselExampleCaptions" 
      ...
      `;
export const carouseldata4 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
export const carouseldata6 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
`;
export const carouseldata5 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
`;
export const carouseldata7 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
export const carouseldata8 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<SpkButton variant='' type="button" className="btn-close"
      disabled aria-label="Close"></SpkButton>`;
