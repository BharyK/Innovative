...
{roundedwithbtnalert.map((idx,index) => (
    <Alert variant={idx.class} className="alert rounded-pill alert-dismissible 
    custom-rounded-alerts fade show" key={index} show={alert['close&#36;{index}']}>
        {idx.text}
        <SpkButton variant='' type="button" className="btn-close custom-close" 
        data-bs-dismiss="alert" aria-label="Close"
            onClickfunc={() => handleRemoveAlert('close&#36;{index}')}>
            <i className="bi bi-x"></i></SpkButton>
    </Alert>
    ))} // End Prism Code//`;
...
export const objectfit3 =
    ` <img src={media28} className="object-fit-contain border rounded" alt="..." /> // End Prism Code//`;

export const objectfit4 =
    `<img src={media28} className="object-fit-cover border rounded" alt="..." /> // End Prism Code//`;

export const objectfit1 =
    `<img src={media28} className="object-fit-fill border rounded" alt="..." /> // End Prism Code//`;

export const objectfit2 =
    ` <img src={media28} className="object-fit-scale border rounded" alt="..." /> // End Prism Code//`;

export const objectfit5 =
    ` <img src={media28} className="object-fit-none border rounded" alt="..." /> // End Prism Code//`;

export const objectfit6 =
    ` <img src={media28} className="object-fit-sm-contain border rounded" alt="..." /> // End Prism Code//`;

export const objectfit7 =
    ` <img src={media28} className="object-fit-md-contain border rounded" alt="..." /> // End Prism Code//`;

export const objectfit8 =
    ` <img src={media28} className="object-fit-lg-contain border rounded" alt="..." /> // End Prism Code//`;

export const objectfit9 =
    `<img src={media28} className="object-fit-xl-contain border rounded" alt="..." /> // End Prism Code//`;

export const objectfit10 =
    ` <img src={media28} className="object-fit-xxl-contain border rounded" alt="..." /> // End Prism Code//`;

export const objectfit11 =
    `  <video src={video} className="object-fit-contain rounded border" autoPlay loop muted></video> // End Prism Code//`;

export const objectfit12 =
    ` <video src={video} className="object-fit-fill rounded border" autoPlay loop muted></video> // End Prism Code//`;
...
export const reusableprogress6 = `	{Coloreddata.map((idx,index) => (
...
{CustomProgress2data.map((idx,index) => (
    <div className={'progress progress-bar progress-sm &#60{idx.class3}'} key={index} >
...
<SpkToast toastClass="align-items-center text-bg-info border-0 fade show mb-4" show={show} message="Hello, world! This is Info toast message. " btnClass="btn-close btn-close-white me-2 m-auto" onclick={toggleShow} ToastBtn={true} ToastHeader={false} />`
...
import SpkToast from "@/shared/@spk-reusable-components/reusable-uiElements/spk-toast";
 ...
 <SpkToast ToastHeader={true} bg="primary-transparent" toastClass="colored-toast" onClose={() => setShow(false)} show={show} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary" imgClass="bd-placeholder-img rounded me-2" imgSrc={togglewhite} message="Your,toast message here." title="Xintra" />`
...
import SpkToast from "@/shared/@spk-reusable-components/reusable-uiElements/spk-toast";
 ...
 <SpkToast ToastHeader={true} show={show} onClose={toggleShow} toastClass="show" headerClass="text-default" imgClass="me-2" imgSrc={togglelogo} title="Xintra" timestamp="11 mins ago" message="Hello, world! This is a toast message." />`
...
<SpkToast ToastHeader={false} toastClass="lign-items-center fade show mb-3" show={show0} ToastBtn={true} message="Hello, world! This is Primary toast message. " btnClass="btn-close me-2 m-auto" onclick={toggleShow0} />`
...
<SpkToast ToastHeader={true} show={show2} onClose={toggleShow2} toastClass="fade show shadow-lg" headerClass="text-default" imgClass="bd-placeholder-img rounded me-2" imgSrc={togglelogo} title="Xintra" timestamp="11 mins ago" message="Hello, world! This is a toast message." />`
// end toasts
...
<p className="mb-0"><Link className="link-opacity-100" to="#!" >Link opacity 100</Link></p> // End Prism Code//`;
