...
export const bgoutline: Bgoutline[] = [
    ...
    { id: 6, color: "outline-danger", class: ".bg-danger-outline" },
...
interface OpacityValuesType {
    id: number;
    value: number;
    color: string
}
export const OpacityValues: OpacityValuesType[] = [
...
export const TextColors: TextColorsType[] = [
    { id: 1, className: 'text-primary', label: 'primary' },
    { id: 2, className: 'text-secondary', label: 'secondary' },
    { id: 3, className: 'text-warning', label: 'warning' },
    { id: 4, className: 'text-info', label: 'info' },
    { id: 5, className: 'text-success', label: 'success' },
    { id: 6, className: 'text-danger', label: 'danger' },
    { id: 7, className: 'text-light bg-dark', label: 'light' },
    { id: 8, className: 'text-dark', label: 'dark' },
    { id: 9, className: 'text-muted', label: 'muted' }
];
