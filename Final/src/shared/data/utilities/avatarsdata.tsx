...
export const Avataricon: Icontype[] = [
    { id: 1, marginClass: true, class: "xs", src: face2, icon: "camera", class1: "success" },
    { id: 2, marginClass: false, class: "sm", src: face3, icon: "edit", class1: "secondary" },
    { id: 3, marginClass: false, class: "md", src: face14, icon: "plus", class1: "warning" },
    { id: 4, marginClass: false, class: "lg", src: face13, icon: "edit", class1: "info" },
    { id: 5, marginClass: false, class: "xl", src: face15, icon: "camera", class1: "success" },
    { id: 6, marginClass: false, class: "xxl", src: face1, icon: "plus", class1: "danger" },
]
...
export const Avatarnumber = [
    { id: 1, marginclass: true, class: "xs", src: face2, icon: "camera", class1: "primary", data: '2' },
    { id: 2, marginclass: false, class: "sm", src: face3, icon: "edit", class1: "secondary", data: '5' },
    { id: 3, marginclass: false, class: "md", src: face14, icon: "plus", class1: "warning", data: '1' },
    { id: 4, marginclass: false, class: "lg", src: face13, icon: "edit", class1: "info", data: '7' },
    { id: 5, marginclass: false, class: "xl", src: face15, icon: "camera", class1: "success", data: '3' },
    { id: 6, marginclass: false, class: "xxl", src: face1, icon: "plus", class1: "danger", data: '9' },
]
