...
const MyDatePicker = () => {
    ...
    return (
        <SpkDatepickr className="form-control" selected={dates["AssignedDate"] ? new Date(dates["AssignedDate"]) : null} onChange={(date: Date | null) => handleDateChange("AssignedDate", date)} dateFormat="yyyy-MM-dd" placeholderText='Select DOB' />
    );
};
                        ...
                        <Col xl={12}>
                            <div className="register-page">
                                ...
                                <div className="row gy-3">
                                    ...
                                    <Col xl={6} className='formWizard custom-inputfield'>
                                        <Form.Label className="form-label">Date of Birth</Form.Label>
                                        <MyDatePicker />
                                    </Col>
                                    <Col xl={6} className='custom-font-size'>
                                        <Form.Label className="form-label">Select Gender :</Form.Label>
                                ...
                                <Row>
                                    <Col xl={12}>
                                        <div className="mb-3">
                                            ...
                                            <div className="input-group formwizard ">
                                                <Form.Control type="text" className='border-end-0' placeholder="Address" aria-label="address" aria-describedby="payment-address" defaultValue="1234 Elm Street,Anytown, USA,12345" />
                                            ...
                                            <Card.Body>
                                                ...
                                                <div className="row gy-3">
                                                    ...
                                                    <Col xl={4}>
                                                        ...
                                                        <label htmlFor="payment-security" className="form-label mt-1 text-primary fs-11"><sup><i className="ri-star-s-fill"></i></sup>Do not share O.T.P with anyone</label>
                                                    </Col>
                                                    <Col xl={12}>
                                                        <div className="form-check">
                                                            <input className="form-check-input form-checked-primary" type="checkbox" id="payment-card-save" defaultChecked />
                    ...
                    <Row className='wizard-content container'>
                        <Col xl={12}>
                            <div className="checkout-payment-success">
                                <div className="mb-4">
                                    <h5 className="text-primary fw-medium">Appointment Booked...</h5>
                                </div>
                                <div className="mb-4">
                                    <img src={png7} alt="" className="img-fluid" />
                                </div>
                                <div className="mb-4">
                                    <p className="mb-1 fs-14">You will get the appointment details with appointment id <b>SPK#1FR</b> to <a className="link-primary" href="#!"><u>Jogh12@gamil.com</u></a></p>
                                    <p className="text-muted">Thank you for booking an appointment .</p>
                                </div>
                                <Link to="#!" className="btn btn-primary">Book Another Appointment</Link>
                            </div>
                        </Col>
                    </Row>
                </div>
