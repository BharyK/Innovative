...
export const ActiveButtons: activebtn[] = [
	{ id: 1, icon: "house-door", text: "Home", class1: "active", class2: 'white' },
	{ id: 2, icon: "bell", text: "Notifications", class1: "", class2: 'primary' },
	{ id: 3, icon: "gift", text: "Sent Messages", class1: "", class2: 'primary' },
	{ id: 4, icon: "person", text: "New Requests", class1: "", class2: 'primary' },
	{ id: 5, icon: "trash3", text: "Deleted Messages", class1: "", class2: 'primary' },
];
