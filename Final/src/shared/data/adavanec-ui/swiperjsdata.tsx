...
export const Basicdata = [
    <div><img src={media27} className="!rounded-md" alt="" /></div>,
    <div><img src={media26} className="!rounded-md" alt="" /></div>,
    <div><img src={media25} className="!rounded-md" alt="" /></div>,
];

export const Navigationdata = [
    <div><img src={media32} alt="" /></div>,
    <div><img src={media28} alt="" /></div>,
    <div><img src={media30} alt="" /></div>,
];

export const Paginationdata = [
    <div><img src={media32} className="h-100 w-100" alt="" /></div>,
    <div><img src={media31} className="h-100 w-100" alt="" /></div>,
    <div><img src={media33} className="h-100 w-100" alt="" /></div>,
];

export const Dynamicdata = [
    <div><img src={media21} alt="" /></div>,
    <div><img src={media17} alt="" /></div>,
    <div><img src={media16} alt="" /></div>,
];

export const Progressdata = [
    <div><img src={media12} alt="" /></div>,
    <div><img src={media8} alt="" /></div>,
    <div><img src={media5} alt="" /></div>,
];

export const Fractiondata = [
    <div><img src={media16} alt="" /></div>,
    <div><img src={media30} alt="" /></div>,
    <div><img src={media31} alt="" /></div>,
];

export const Customdata = [
    <div><img src={media25} alt="" /></div>,
    <div><img src={media5} alt="" /></div>,
    <div><img src={media33} alt="" /></div>,
];

export const Scrollbardata = [
    <div><img src={media30} alt="" /></div>,
    <div><img src={media28} alt="" /></div>,
    <div><img src={media29} alt="" /></div>,
];

export const Verticaldata = [
    <div className='verticalswiper'><img src={media8} alt="" /></div>,
    <div className='verticalswiper'><img src={media32} alt="" /></div>,
    <div className='verticalswiper'><img src={media17} alt="" /></div>,
];

export const Mousewheeldata = [
    <div className='verticalswiper'><img src={media28} alt="" /></div>,
    <div className='verticalswiper'><img src={media30} alt="" /></div>,
    <div className='verticalswiper'><img src={media32} alt="" /></div>,
];
...
export const Effectcubedata = [
    <div><img src={media62} alt="" /></div>,
    <div><img src={media63} alt="" /></div>,
    <div><img src={media64} alt="" /></div>,
];

export const Effectfadedata = [
    <div><img src={media18} alt="" /></div>,
    <div><img src={media19} alt="" /></div>,
    <div><img src={media20} alt="" /></div>,
];

export const Effectflipdata = [
    <div><img src={media20} alt="" /></div>,
    <div><img src={media62} alt="" /></div>,
    <div><img src={media63} alt="" /></div>,
];

export const Effectcovberflowdata = [
    <div><img src={media40} alt="" /></div>,
    <div><img src={media41} alt="" /></div>,
    <div><img src={media42} alt="" /></div>,
    <div><img src={media43} alt="" /></div>,
    <div><img src={media44} alt="" /></div>,
    <div><img src={media59} alt="" /></div>,
    <div><img src={media60} alt="" /></div>,
    <div><img src={media61} alt="" /></div>,
];

export const Thumbdata = [
    <div><img src={media1} alt="" /></div>,
    <div><img src={media2} alt="" /></div>,
    <div><img src={media11} alt="" /></div>,
    <div><img src={media6} alt="" /></div>,
    <div><img src={media7} alt="" /></div>,
    <div><img src={media10} alt="" /></div>,
    <div><img src={media11} alt="" /></div>,
];
