...
const ImagesFigures = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Responsive image" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image5}>
                ...
                <Col xl={6}>
                    <ShowCode title="Image With Radius" customCardClass="custom-card" customCardBodyClass=" border border-dashed m-2 mt-0 rounded-1" reactCode={image4}>
                ...
                <Col xl={6}>
                    <ShowCode title="Rounded Image" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image6}>
                ...
                <Col xl={6}>
                    <ShowCode title="Image Left Align" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image3}>
                ...
                <Col xl={6}>
                    <ShowCode title="Image Center Align" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image1}>
                        <img className="rounded mx-auto d-block" src={media55} alt="..." />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Image Right Align" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image2}>
                        <img className="rounded float-end" src={media54} alt="..." />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Figures" reactCode={image9} customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1 d-flex justify-content-between gap-2">
                ...
                <Col xl={3}>
                    <ShowCode title="Image Thumbnail" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image7}>
                ...
                <Col xl={3}>
                    <ShowCode title="Rounded Thumbnail" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={image8}>
