...
const Buttons = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Default Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton1} reactCode={reactButton1} reusableCode={reuseButton1}>
                        <div className="btn-list">
                            {DefaultButtons.map((idx, index) => (
                                <SpkButton Buttontype="button" Buttonvariant={idx.class} Customclass={`waves-effect waves-light me-2 ${idx.btnClass}`} key={index}>{idx.text}</SpkButton>
                            ))}
                        </div>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Rounded Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton1} reactCode={reactButton2} reusableCode={reuseButton2}>
                        <div className="btn-list">
                            {DefaultButtons.map((idx, index) => (
                                <SpkButton Buttontype="button" Buttonvariant={idx.class} Customclass={`rounded-pill me-2 ${idx.btnClass}`} key={index}>{idx.text}</SpkButton>
                            ))}
                        </div>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Light Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactbutton1} reusableCode={reusebutton1}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Light Rounded Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton3} reactCode={reactButton3} reusableCode={reuseButton3}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Outline Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton5} reactCode={reactButton5} reusableCode={reuseButton5}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Rounded Outline Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton5} reactCode={reactButton6} reusableCode={reuseButton6}>
                        <div className="btn-list">
                            {OutlineButtons.map((idx, index) => (
                                <SpkButton Buttontype="button" Buttonvariant={idx.class} Customclass=" rounded-pill me-2" key={index}>{idx.text}</SpkButton>
                            ))}
                ...
                <Col xl={6}>
                    <ShowCode title="Gradient Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton7} reactCode={reactButton7} reusableCode={reuseButton7}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Rounded Gradient Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton8} reactCode={reactButton8} reusableCode={reuseButton8}>
                        <div className="btn-list">
                            {GradientButtons.map((idx, index) => (
                                <SpkButton Buttontype="button" Buttonvariant={idx.class} Customclass="rounded-pill me-2" key={index}>{idx.text}</SpkButton>
                            ))}
                ...
                <Col xl={6}>
                    <ShowCode title="Ghost Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton9} reactCode={reactButton9} reusableCode={reuseButton9}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Button tags" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton10} reusableCode={reuseButton10}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="disabled state with anchor tags" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton11} reusableCode={reuseButton11}>
                        <div className="btn-list">
                            <div className="mb-4">
                ...
                <Col xl={6}>
                    <ShowCode title="button plugin toggle states" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton12} reusableCode={reuseButton12}>
                        <div className="btn-list">
                            <div className="mb-4">
                ...
                <Col xl={6}>
                    <ShowCode title=" Link functionally caveat" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton13} reusableCode={reuseButton13}>
                        <div className="btn-list">
                            <SpkButton Buttontype="button" Buttonvariant="primary" Disabled={true}>Primary link</SpkButton>
                            <SpkButton Buttontype="button" Buttonvariant="secondary" Disabled={true}>Link</SpkButton>
                        </div>
                ...
                <Col xl={6}>
                    <ShowCode title="Loading Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton14} reusableCode={reuseButton14}>
                ...
                <Col xl={6}>
                    <ShowCode title="Icon Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton15} reusableCode={reuseButton15}>
                        <div className="btn-list d-md-flex d-block">
                            ...
                            <div className="mb-md-0 mb-2">
                                <SpkButton Buttontype="button" Buttonvariant="primary-light" Customclass="rounded-pill btn-icon">
                                    <i className="ri-home-smile-line"></i>
                                </SpkButton>
                                <SpkButton Buttontype="button" Buttonvariant="secondary-light" Customclass="rounded-pill btn-icon">
                                    <i className="ri-delete-bin-line"></i>
                                </SpkButton>
                                <SpkButton Buttontype="button" Buttonvariant="success-light" Customclass="rounded-pill btn-icon">
                                    <i className="ri-notification-3-line"></i>
                                </SpkButton>
                                <SpkButton Buttontype="button" Buttonvariant="danger-light" Customclass="rounded-pill btn-icon me-5">
                ...
                <Col xl={6}>
                    <ShowCode title="Icon Button Sizes" reactCode={reactButton16} reusableCode={reuseButton16}>
                        <div className="btn-list d-md-flex d-block gap-5">
                            ...
                            <div className="mb-md-0 mb-2">
                                <SpkButton Size="sm" Buttontype="button" Buttonvariant="primary-transparent" Customclass="rounded-pill btn-icon">
                                    <i className="ri-home-smile-line"></i>
                                </SpkButton>
                                <SpkButton Buttontype="button" Buttonvariant="secondary-light" Customclass="rounded-pill btn-icon">
                                    <i className="ri-delete-bin-line"></i>
                ...
                <Col xl={6}>
                    <ShowCode title=" Social Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" dataCode={dataButton17} reactCode={reactButton17} reusableCode={reuseButton17}>
                ...
                <Col xl={6}>
                    ...
                    <ShowCode title="Sizes" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton18} reusableCode={reuseButton18}>
                        <div className="btn-list">
                            ...
                            <SpkButton Size="lg" Buttontype="button" Buttonvariant="danger" Customclass="">
                                Large button
                            </SpkButton>
                        </div>
                    </ShowCode>
                ...
                <Col xl={6}>
                    <div className="row">
                        <Col xl={12}>
                            <ShowCode title="Button Widths" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton19} reusableCode={reuseButton19}>
                                <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Buttons With Different Shadows" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton20} reusableCode={reuseButton20}>
                        <div className="btn-list d-flex">
                            ...
                            <div>
                                ...
                                <SpkButton Size="lg" Buttontype="button" Buttonvariant="warning" Customclass="shadow-lg">Button</SpkButton>
                            </div>
                        </div>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Different Colored Buttons With Shadows" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton21} dataCode={dataButton21} reusableCode={reuseButton21}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Raised Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton22} dataCode={dataButton22} reusableCode={reuseButton22}>
                        <div className="btn-list">
                            {ColoredButtons.map((idx, index) => (
                ...
                <Col xl={6}>
                    <ShowCode title="Label Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton23} reusableCode={reuseButton23}>
                        <div className="btn-list">
                ...
                <Col xl={6}>
                    <ShowCode title="Custom Buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton24} reusableCode={reuseButton24}>
                        <div className="btn-list">
                ...
                <Col xl={12}>
                    <ShowCode title="Block buttons" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={reactButton25} reusableCode={reuseButton25}>
                        <div className="btn-list">
