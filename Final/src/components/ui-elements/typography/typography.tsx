...
const Typography = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Headings H tags" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography1}>
                    ...
                    <ShowCode title="Heading Class Names" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography2}>
                ...
                <Col xl={6}>
                    <ShowCode title="Display headings" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography3}>
                    ...
                    <ShowCode title="Customizing headings" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography4}>
                        <h3>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Inline text elements" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography5}>
                ...
                <Col xl={6}>
                    <ShowCode title="Font Sizes" customCardClass="custom-card" customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography6}>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Lead Paragraph" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography7}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Left Aligned" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography8}>
                ...
                <Col xl={6}>
                    <ShowCode title="Right Aligned" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography9}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Primary Blockquote" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography10}>
                ...
                <Col xl={6}>
                    <ShowCode title="Secondary Blockquote" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography11}>
                ...
                <Col xl={6}>
                    <ShowCode title="Warning Blockquote" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography12}>
                ...
                <Col xl={6}>
                    <ShowCode title="Success Blockquote" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography13}>
                ...
                <Col xl={6}>
                    <ShowCode title="Info Blockquote" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography14}>
                ...
                <Col xl={6}>
                    <ShowCode title="Danger Blockquote" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography15}>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Description list alignment" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography16}>
                ...
                <Col xl={12}>
                    <ShowCode title="List Unstyled" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography17}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Abbreviations" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography18}>
                        <p><abbr title="attribute">attr</abbr></p>
                        <p className="mb-0"><abbr title="HyperText Markup Language" className="initialism">HTML</abbr></p>
                    </ShowCode>
                    <ShowCode title="List inline" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography19}>
                ...
                <Col xl={6}>
                    <ShowCode title="Horizontal rules" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography20}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Text transform" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography21}>
                ...
                <Col xl={6}>
                    <ShowCode title="Text decoration" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography22}>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Font weight and italics" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography23}>
                ...
                <Col xl={12}>
                    <ShowCode title="Line height" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography24}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Monospace" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography25}>
                        <p className="font-monospace mb-0">This is in monospace</p>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Reset color" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography26}>
                ...
                <Col xl={6}>
                    <ShowCode title="Visible text" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography27}>
                        <p className="visible mb-0">This is visible text</p>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Invisible text" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography28}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Text alignment" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography29}>
                ...
                <Col xl={6}>
                    <ShowCode title="Text wrapping and overflow" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography30}>
                    ...
                    <ShowCode title="Word break" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={typography31}>
