        ...
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="TEXT SELECTION" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={link6}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="POINTER EVENTS" reactCode={link5} customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
                        ...
                        <Col xl={12}>
                            <ShowCode title="  LINK OPACITY" reactCode={link8} customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
                        ...
                        <Col xl={12}>
                            <ShowCode title="LINK HOVER VARIANT" customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={link7}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="LINK UNDERLINE COLORS" reactCode={link9} customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" customCardHeaderClass="justify-content-between" >
                ...
                <Col xl={6}>
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="LINK UNDERLINE OFFSET" reactCode={link2} customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
                        ...
                        <Col xl={12}>
                            <ShowCode title=" LINK UNDERLINE OPACITY" reactCode={link3} customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
                        ...
                        <Col xl={12}>
                            <ShowCode title="LINK HOVER OPACITY" reactCode={link1} customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
                        ...
                        <Col xl={12}>
                            <ShowCode title="COLORED LINKS" reactCode={link4} customCardHeaderClass="justify-content-between" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
