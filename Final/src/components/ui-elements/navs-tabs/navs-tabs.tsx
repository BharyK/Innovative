...
import { Card, Col, Nav, Row, Tab, NavDropdown } from "react-bootstrap";
                        ...
                        <Tab.Container defaultActiveKey="home">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="home" className="" id="home1" role="tabpanel">
                                        <b>Lorem Ipsum is simply dummy</b> text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text ever since the
                                        1500s, when an unknown printer took a galley of type and scrambled it to make a
                                        type specimen book. It has survived not only five centuries.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="about" className=" " id="about1" role="tabpanel">
                                    ...
                                    <Tab.Pane eventKey="service" className=" " id="service1" role="tabpanel">
                                        There are many variations of passages of <b>Lorem Ipsum available</b>, but the
                                        majority have suffered alteration in some form, by injected humour, or
                                        randomised words which don't look even slightly believable. If you are going to
                                        use a passage of Lorem Ipsum, you need to be sure there isn't anything.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="license" className=" " id="license1" role="tabpanel">
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="service1">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="home1" className=" " id="home1-justified" role="tabpanel">
                                        Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                                        in a piece of classical Latin literature from 45 BC, <b>Making it over 2000
                                            years old</b>. Richard McClintock, a Latin professor at Hampden-Sydney
                                        College in Virginia, looked up one of the more obscure Latin words, consectetur.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="about1" className=" " id="about1-justified" role="tabpanel">
                                        <b>Lorem Ipsum is simply dummy</b> text of the printing and typesetting
                                        industry. Lorem Ipsum has been the industry's standard dummy text ever since the
                                        1500s, when an unknown printer took a galley of type and scrambled it to make a
                                        type specimen book. It has survived not only five centuries.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="service1" className="" id="service1-justified"
                                        role="tabpanel">
                                        There are many variations of passages of <b>Lorem Ipsum available</b>, but the
                                        majority have suffered alteration in some form, by injected humour, or
                                        randomised words which don't look even slightly believable. If you are going to
                                    ...
                                    <Tab.Pane eventKey="license1" className=" " id="license1-justified" role="tabpanel">
                                        It is a long established fact that a reader will be distracted by the
                                        <b><i>Readable content</i></b> of a page when looking at its layout. The point
                                        of using Lorem Ipsum is that it has a more-or-less normal distribution of
                                        letters, as opposed to using 'Content here, content here', making it look like
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="cart">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="products" className=" " id="nav-products" role="tabpanel">
                                    ...
                                    <Tab.Pane eventKey="cart" className="" id="nav-cart" role="tabpanel">
                                    ...
                                    <Tab.Pane eventKey="orders" className=" " id="nav-orders" role="tabpanel">
                                    ...
                                    <Tab.Pane eventKey="offers" className=" " id="nav-offers" role="tabpanel">
                            ...
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Nav className="nav-style-6 nav-pills mb-3 nav-justified d-sm-flex d-block" role="tablist">
                                    ...
                                    <Nav.Link eventKey="cart1" className="" data-bs-toggle="tab" role="tab"
                                        href="#nav-cart-justified" aria-selected="true">Cart <SpkBadge variant="info"
                                    ...
                                    <Nav.Link eventKey="offers1" className="" data-bs-toggle="tab" role="tab" href="#nav-offers-justified"
                                        aria-selected="false">Offers <SpkBadge variant="warning"
                                            Customclass="ms-1">7</SpkBadge></Nav.Link>
                                </Nav>
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="products1" className=" " id="nav-products-justified" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it. How
                                    ...
                                    <Tab.Pane eventKey="cart1" className="" id="nav-cart-justified"
                                        role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                    ...
                                    <Tab.Pane eventKey="orders1" className=" " id="nav-orders-justified" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick. The complete beginner's guide to cooking
                                    ...
                                    <Tab.Pane eventKey="offers1" className=" " id="nav-offers-justified" role="tabpanel">
                                        Why delicious magazines are killing you. Why our world would end if restaurants
                                        disappeared. Why restaurants are on crack about restaurants. How restaurants are
                                        making the world a better place. 8 great articles about minute meals. Why our
                                        world would end if healthy snacks disappeared. Why the world would end without
                                ...
                                <Row>
                                    ...
                                    <Col xl={9}>
                                        <Tab.Content className=" mt-2 mt-xl-0">
                                            <Tab.Pane eventKey="vertical1" className="" id="home-vertical"
                                                role="tabpanel">
                                            ...
                                            <Tab.Pane eventKey="vertical2" className=" " id="about-vertical"
                                                role="tabpanel">
                                            ...
                                            <Tab.Pane eventKey="vertical3" className=" " id="services-vertical"
                                                role="tabpanel">
                                            ...
                                            <Tab.Pane eventKey="vertical4" className=" " id="contacts-vertical"
                                                role="tabpanel">
                            ...
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Row>
                                    ...
                                    <div className="col-xl-9">
                                        <Tab.Content className=" mt-2 mt-xl-0">
                                            <Tab.Pane eventKey="tab1" className=" " id="home-vertical-link"
                                                role="tabpanel">
                                                How hotel deals can help you live a better life. <b>How celebrity
                                                    cruises</b> aren't as bad as you think. How cultural solutions
                                                can help you predict the future. How to cheat at dog friendly hotels
                                            ...
                                            <Tab.Pane eventKey="tab2" className=" " id="about-vertical-link"
                                                role="tabpanel">
                                                How travel coupons make you a better lover. Why cultural solutions
                                                are the new black. Why mom was right about travel insurances. How
                                                family trip ideas can help you predict the future. <b>How carnival
                                            ...
                                            <Tab.Pane eventKey="tab3" className="" id="services-vertical-link"
                                                role="tabpanel">
                                                Unbelievable healthy snack success stories. 12 facts about safe food
                                                handling tips that will impress your friends. Restaurant weeks by
                                            ...
                                            <Tab.Pane eventKey="tab4" className=" " id="contacts-vertical-link"
                                                role="tabpanel">
                                                Why delicious magazines are killing you. Why our world would end if
                                                restaurants disappeared. Why restaurants are on crack about
                                                restaurants. How restaurants are making the world a better place. 8
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="tabs1">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="tabs1" className="" id="home-center" role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                        you'll never succeed at daily deals. 11 ways cheapest flights can find you the
                                    ...
                                    <Tab.Pane eventKey="tabs2" className=" " id="about-center" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it. How
                                    ...
                                    <Tab.Pane eventKey="tabs3" className=" " id="services-center" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick. The complete beginner's guide to cooking
                                    ...
                                    <Tab.Pane eventKey="tabs4" className=" " id="contacts-center" role="tabpanel">
                                        Why delicious magazines are killing you. Why our world would end if restaurants
                                        disappeared. Why restaurants are on crack about restaurants. How restaurants are
                                        making the world a better place. 8 great articles about minute meals. Why our
                                        world would end if healthy snacks disappeared. Why the world would end without
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="right1">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="right1" className=" " id="home-right" role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                        you'll never succeed at daily deals. 11 ways cheapest flights can find you the
                                    ...
                                    <Tab.Pane eventKey="right2" className=" " id="about-right" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it. How
                                    ...
                                    <Tab.Pane eventKey="right3" className=" " id="services-right" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick. The complete beginner's guide to cooking
                                    ...
                                    <Tab.Pane eventKey="right4" className=" " id="contacts-right" role="tabpanel">
                                        Why delicious magazines are killing you. Why our world would end if restaurants
                                        disappeared. Why restaurants are on crack about restaurants. How restaurants are
                                        making the world a better place. 8 great articles about minute meals. Why our
                                        world would end if healthy snacks disappeared. Why the world would end without
                ...
                <Col xl={6}>
                    <Tab.Container defaultActiveKey="header1">
                        <Card className="custom-card">
                            ...
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="header1" className="" id="home-header"
                                        role="tabpanel">
                                        <ul className="mb-0">
                                            <li className="mb-2">
                                                How hotel deals can help you live a better life. <b>How celebrity
                                    ...
                                    <Tab.Pane eventKey="header2" className=" " id="about-header"
                                        role="tabpanel">
                                        <ul className="mb-0">
                                            <li className="mb-2">
                                                How travel coupons make you a better lover. Why cultural solutions
                                    ...
                                    <Tab.Pane eventKey="header3" className=" " id="services-header"
                                        role="tabpanel">
                                        <ul className="mb-0">
                                            <li className="mb-2">
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="footer1">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="footer1" className="" id="home-footer" role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                        you'll never succeed at daily deals. 11 ways cheapest flights can find you the
                                    ...
                                    <Tab.Pane eventKey="footer2" className=" " id="about-footer" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it. How
                                    ...
                                    <Tab.Pane eventKey="footer3" className=" " id="services-footer" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick. The complete beginner's guide to cooking
                            ...
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="orders1" className="" id="orders" role="tabpanel">
                                        <div className=""><b>Lorem Ipsum is simply dummy text of the
                                    ...
                                    <Tab.Pane eventKey="orders2" className="" id="accepted" role="tabpanel">
                                        <div className="">Many desktop publishing packages and web page
                                    ...
                                    <Tab.Pane eventKey="orders3" className="" id="declined" role="tabpanel">
                                        <div className="">There are many variations of passages of Lorem
                        ...
                        <Tab.Container defaultActiveKey="ordertab2">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="" id="myTabContent">
                                    <Tab.Pane eventKey="ordertab1" className=" fade " id="order-tab-pane" role="tabpanel"
                                    ...
                                    <Tab.Pane eventKey="ordertab2" className=" fade " id="confirm-tab-pane"
                                    ...
                                    <Tab.Pane eventKey="ordertab3" className=" fade " id="shipped-tab-pane" role="tabpanel"
                                    ...
                                    <Tab.Pane eventKey="ordertab4" className=" fade " id="delivered-tab-pane" role="tabpanel" tabIndex={0}>
                        ...
                        <Tab.Container defaultActiveKey="hometab">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="" id="myTabContent1">
                                    <Tab.Pane eventKey="hometab" className=" fade " id="home-tab-pane"
                                    ...
                                    <Tab.Pane eventKey="profiletab" className=" fade " id="profile-tab-pane"
                                        ...
                                        years.</Tab.Pane>
                                    <Tab.Pane eventKey="contacttab" className=" fade " id="contact-tab-pane"
                        ...
                        <Tab.Container defaultActiveKey="pillhome">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="" id="pills-tabContent">
                                    <Tab.Pane eventKey="pillhome" className="" id="pills-home" role="tabpanel"
                                    ...
                                    <Tab.Pane eventKey="pillprofile" className=" " id="pills-profile" role="tabpanel"
                                    ...
                                    <Tab.Pane eventKey="pillcontact" className=" " id="pills-contact" role="tabpanel"
                                    ...
                                    <Tab.Pane eventKey="pilldisable" className=" " id="pills-disabled" role="tabpanel"
                                        ...
                                        <div className="table-responsive">
                                            <SpkTables tableClass="mb-0" header={[{ title: 'Product' }, { title: 'Name' }, { title: 'Category' }, { title: 'Price' }]} >
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <img src={jpg4} alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>All-in-One Desktop PC</td>
                                                    <td>Desktop</td>
                                                    <td>$7,249.29</td>
                                                </tr>
                                                <tr className="bg-transparent">
                                                    <th scope="row" className="bg-transparent">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <img src={jpg6} alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Livzing Plastic Flower Pot</td>
                                                    <td>Flower Pot</td>
                                                    <td className="bg-transparent">$799.00</td>
                                                </tr>
                                            </SpkTables>
                                        </div>
                                    </Tab.Pane>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="homestyle">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Nav className=" nav-tabs mb-3 tab-style-8 scaleX" id="myTab4" role="tablist">
                                    <Nav.Item className="" role="presentation">
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="flexhome">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="flexhome" className="" id="pill-flex-home" role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                        you'll never succeed at daily deals. 11 ways cheapest flights can find you the
                                    ...
                                    <Tab.Pane eventKey="flexbig" className=" " id="pill-flex-big" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it. How
                                    ...
                                    <Tab.Pane eventKey="flexabout" className=" " id="pill-flex-about" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick. The complete beginner's guide to cooking
                                                    ...
                                                    <div>
                                                        <div className="my-md-auto mt-4 ms-md-3">
                                                            ...
                                                            <p className="text-muted ms-0 mb-2 pb-2 ">
                                                                <span className="me-3">Ui/Ux  Developer</span>
                                                                <span className="me-3">West fransisco,Alabama</span>
                                                                <span>New Jersey</span>
                                                            </p>
                                                            <p className="text-muted ms-0 mb-2">
                                                                <span><i className="fe fe-phone me-2"></i></span>
                                                                <span className="font-weight-semibold me-2 mx-1">Phone:</span>
                                                                <span>+94  12345 6789</span>
                                                            </p>
                                                            <p className="text-muted ms-0 mb-2">
                                                                <span><i className="fe fe-mail me-2"></i></span>
                                                                <span className="font-weight-semibold me-2 mx-1">Email:</span>
                                                                <span>spruko.space@gmail. com</span>
                                                            </p>
                                                            <p className="text-muted ms-0 mb-2">
                                                                <span><i className="fe fe-globe me-2"></i></span>
                                                                <span className="font-weight-semibold me-2 mx-1">Website:</span>
                            ...
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Row>
                                    ...
                                    <div className="col-md-9">
                                        <Tab.Content className="">
                                            <Tab.Pane eventKey="customhome" className="" id="home-vertical-custom"
                                                role="tabpanel">
                                                <ul className="mb-0">
                                                    <li className="mb-2">
                                                        How hotel deals can help you live a better life. <b>How celebrity
                                            ...
                                            <Tab.Pane eventKey="customabout" className=" " id="about-vertical-custom"
                                                role="tabpanel">
                                                <ul className="mb-0">
                                                    <li className="mb-2">
                                            ...
                                            <Tab.Pane eventKey="customservice" className=" " id="services-vertical-custom"
                                                role="tabpanel">
                                                <ul className="mb-0">
                                                    <li className="mb-2">
                                                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.
                            ...
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                <Row>
                                    ...
                                    <div className="col-md-8">
                                        <Tab.Content className="">
                                            <Tab.Pane eventKey="employee" className="" id="employee-vertical"
                                                role="tabpanel">
                                                <ul className="mb-0">
                                                    <li className="mb-2">
                                                        How hotel deals can help you live a better life. <b>How celebrity
                                            ...
                                            <Tab.Pane eventKey="customers" className=" " id="customers-vertical"
                                                role="tabpanel">
                                                <ul className="mb-0">
                                                    <li className="mb-2">
                                                        The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham,How hotel deals can help you live a better life. <b>How celebrity
                                            ...
                                            <Tab.Pane eventKey="products" className=" " id="products-vertical"
                                                role="tabpanel">
                                                <ul className="mb-0">
                                                    <li className="mb-2">
                                                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="drophome">
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 border-0 custom-tabs" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="drophome" className="" data-bs-toggle="tab" role="tab" href="#tab"
                                            aria-selected="true">Home</Nav.Link>
                                    </Nav.Item>
                                    <NavDropdown title="Company" className="">
                                        <NavDropdown.Item eventKey="drophome1">About</NavDropdown.Item>
                                        <NavDropdown.Item >Another action</NavDropdown.Item>
                                        <NavDropdown.Item className="border-bottom-0">Something else here</NavDropdown.Item>
                                        <NavDropdown.Divider />
                        ...
                        <Tab.Container defaultActiveKey="pillproduct">
                            <Card.Body className="">
                                <Nav className=" nav-pills mb-3" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="pillproduct" className="" data-bs-toggle="tab" role="tab" aria-current="page"
                                            href="#pill-products" aria-selected="true">Products</Nav.Link>
                                    </Nav.Item>

                                    <NavDropdown title="Cart" className="">
                                        <NavDropdown.Item eventKey="pillwishlist">Wishlist</NavDropdown.Item>
                                        <NavDropdown.Item >Liked</NavDropdown.Item>
                                        <NavDropdown.Item className="border-bottom-0">Save For Later</NavDropdown.Item>
                                        <NavDropdown.Divider />
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="fillhome">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="fillhome" className="" id="fill-pill-home" role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                        you'll never succeed at daily deals.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="fillabout" className=" " id="fill-pill-about" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="fillservice" className=" " id="fill-pill-services" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick.
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="justhome">
                            <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="justhome" className="" id="justified-pill-home" role="tabpanel">
                                        How travel coupons make you a better lover. Why cultural solutions are the new
                                        black. Why mom was right about travel insurances. How family trip ideas can help
                                        you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                        you'll never succeed at daily deals.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="justdetail" className=" " id="justified-pill-details" role="tabpanel">
                                        How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                        aren't as bad as you think. How cultural solutions can help you predict the
                                        future. How to cheat at dog friendly hotels and get away with it. 17 problems
                                        with summer activities. How to cheat at travel agents and get away with it.
                                    </Tab.Pane>
                                    <Tab.Pane eventKey="justproduct" className=" " id="justified-pill-products" role="tabpanel">
                                        Unbelievable healthy snack success stories. 12 facts about safe food handling
                                        tips that will impress your friends. Restaurant weeks by the numbers. Will
                                        mexican food ever rule the world? The 10 best thai restaurant youtube videos.
                                        How restaurant weeks can make you sick.
