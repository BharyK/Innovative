                            ...
                            <Card className="custom-card shadow-none my-auto border-0">
                                <Card.Body className="p-5">
                                    ...
                                    <Form onSubmit={Login1}>
                                        <Row className="gy-3">
                                            <Col xl={12}>
                                                ...
                                                <Form.Control autoComplete="false" type="text" className="form-control-lg" id="signin-username" placeholder="user name"
                                                    defaultValue={email} onChange={changeHandler} />
                                            </Col>
                                            <Col xl={12} className="mb-2">
                                                <label htmlFor="signin-password" className="form-label text-default d-block">Password<Link to={`${import.meta.env.BASE_URL}authentication/reset-password/reset-basic`} className="float-end link-danger op-6 fw-medium fs-12">Forget password ?</Link></label>
                                                <div className="position-relative">
                                                    <Form.Control autoComplete="false" type={(passwordShow) ? 'text' : "password"} className="form-control form-control-lg" id="signin-password" placeholder="password"
                                    ...
                                    <div className="text-center">
                                        <p className="text-muted mt-3 mb-0">Don't have an account? <Link to={`${import.meta.env.BASE_URL}authentication/sign-up/sign-up-basic`} className="text-primary fw-medium">Sign Up</Link></p>
                                    </div>
