...
const CreateCover = () => {
    ...
    return (
        <Fragment>
            <Row className="authentication authentication-cover-main mx-0 justify-content-center">
                        ...
                        <Col xxl={8} xl={8} lg={6} md={6} sm={8} className="col-12">
                            <Card className="custom-card shadow-none my-auto border-0">
                                <Card.Body className="p-5">
                                    ...
                                    <p className="mb-4 fs-13 text-muted fw-normal">Set a secure password to protect your account.</p>
                                    <Form onSubmit={handleSubmit}>
                                        <Row className="gy-3">
                                            <Col xl={12}>
                                                <label htmlFor="create-password" className="form-label text-default">Password</label>
                                                <div className="position-relative">
                                                    <Form.Control type={passwordVisibility.password ? 'text' : 'password'} autoComplete="false" className="form-control-lg" id="create-password" placeholder="password"
                                            ...
                                            <Col xl={12}>
                                                ...
                                                <div className="position-relative">
                                                    <Form.Control type={passwordVisibility.passwords ? 'text' : 'password'} autoComplete="false" className="form-control-lg" id="create-confirmpassword" placeholder="password"
