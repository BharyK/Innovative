...
const Tables = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic Tables" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable1} reusableCode={reusableTable1}>
                ...
                <Col xl={6}>
                    <ShowCode title="Bordered Tables" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable2} dataCode={loopTable2} reusableCode={reusableTable2}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title=" Bordered Primary" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable3} dataCode={loopTable3} reusableCode={reusableTable3}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Bordered Secondary" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable4} dataCode={loopTable4} reusableCode={reusableTable4}>
                        <div className="table-responsive">
                            <SpkTables tableClass="text-nowrap table-bordered border-secondary" header={[{ title: 'Order' }, { title: 'Date' }, { title: 'Customer' }, { title: 'Status' }]}>
                                {Successtable.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td><SpkBadge variant="secondary-transparent">Delivered</SpkBadge></td>
                                    </tr>
                                ))}
                            </SpkTables>
                        </div>
                ...
                <Col xl={4}>
                    <ShowCode title="Bordered warning" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={BasicTable5} dataCode={loopTable5} reusableCode={reusableTable5}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Table Without Borders" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" dataCode={loopTable6} reactCode={basicTable6} reusableCode={reusableTable6}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Group Dividers" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" dataCode={loopTable7} reactCode={basicTable7} reusableCode={reusableTable7}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Striped rows" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable8} dataCode={loopTable8} reusableCode={reusableTable8}>
                        <div className="table-responsive">
                            <SpkTables tableClass="text-nowrap table-striped" header={[{ title: 'ID' }, { title: 'Date' }, { title: 'Customer' }, { title: 'Action' }]}>
                                {Strippedtable.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{idx.name}</td>
                                        <td>
                                            <SpkButton Buttonvariant="primary" Size="sm" Customclass="waves-effect waves-light"> <i className="ri-download-2-line align-middle me-2 d-inline-block"></i>Download </SpkButton>
                                        </td>
                                    </tr>
                                ))}
                            </SpkTables>
                ...
                <Col xl={6}>
                    <ShowCode title="Striped columns" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable9} dataCode={loopTable8} reusableCode={reusableTable9}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title="Primary Table" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable10} dataCode={loopTable10} reusableCode={reusabletable10}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Secondary Table" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable11} dataCode={loopTable10} reusableCode={reusableTable11}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Warning Table" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable12} dataCode={loopTable10} reusableCode={reusableTable12}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Danger Table" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable13} dataCode={loopTable10} reusableCode={reusableTable13}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Dark Table" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable14} dataCode={loopTable10} reusableCode={reusableTable14}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Success Table With Striped Rows" customCardClass="custom-card" customCardBodyClass="" customCardHeaderClass="pb-0" reactCode={basicTable15} dataCode={loopTable10} reusableCode={reusableTable15}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Hoverable Rows" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable16} reusableCode={reusableTable16} dataCode={loopTable16} >
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title=" Hoverable rows With striped rows" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable17} dataCode={loopTable17} reusableCode={reusableTable17}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Table Head Primary" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable18} dataCode={loopTable18} reusableCode={reusableTable18}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head warning" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable19} dataCode={loopTable19} reusableCode={reusableTable19}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Success" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable20} dataCode={loopTable19} reusableCode={reusableTable20} >
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Info" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable21} dataCode={loopTable19} reusableCode={reusableTable21}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Secondary" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable22} dataCode={loopTable19} reusableCode={reusableTable22}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Danger" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable23} dataCode={loopTable19} reusableCode={reusableTable23}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title="Table Foot" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable24} dataCode={loopTable24} reusableCode={reusableTable24}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Table With Caption" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable25} dataCode={loopTable25} reusableCode={reusableTable25}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Table With Top Caption" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable26} reusableCode={reusableTable26} dataCode={loopTable26} >
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Active Tables" customCardHeaderClass="pb-0" customCardClass="custom-card" reactCode={basicTable27} reusableCode={reusableTable27} dataCode={loopTable27} >
                        <div className="table-responsive">
                            <SpkTables tableClass="text-nowrap" header={[{ title: 'Name' }, { title: 'Created On' }, { title: 'Number' }, { title: 'Status' }]}>
                ...
                <Col xl={6}>
                    <ShowCode title="Small Tables" customCardClass="custom-card" customCardHeaderClass="pb-0" customCardBodyClass="" reactCode={basicTable28} dataCode={loopTable28} reusableCode={reusableTable28}>
                        <div className="table-responsive">
                            <SpkTables tableClass="text-nowrap table-sm" header={[{ title: 'Invoice' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Action' }]}>
                                {Smalltables.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{idx.date}</td>
                                        <td><SpkBadge variant={idx.class} Customclass="">{idx.text}</SpkBadge></td>
                                        <td>
                                            <div className="hstack gap-2 fs-15">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Color variants tables" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable29} dataCode={loopTable29} reusableCode={reusableTable29}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Nesting" customCardClass="custom-card" customCardHeaderClass="pb-0" customCardBodyClass="" reactCode={basicTable30} reusableCode={reusableTable30}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Always responsive" customCardClass="custom-card" customCardHeaderClass="pb-0" reactCode={basicTable31} reusableCode={reusableTable31} dataCode={loopTable31} >
                        <div className="table-responsive">
                            <SpkTables tableClass="text-nowrap" showCheckbox={true} header={[{ title: 'Team Head' }, { title: 'Category' }, { title: 'Role' }, { title: 'Gmail' }, { title: 'Team' }, { title: 'Work Progress' }, { title: 'Revenue' }, { title: 'Action' }]}>
                                {Responsivedata.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="hstack gap-2 fs-15">
                                                <Link to="#!" className="btn btn-icon btn-sm btn-secondary"><i className="ri-download-2-line"></i></Link>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Vertical alignment" customCardClass="custom-card vertical-alignment-table" customCardHeaderClass="pb-0" reactCode={basicTable32} dataCode={loopTable32} reusableCode={reusableTable32}>
                        <div className="table-responsive">
