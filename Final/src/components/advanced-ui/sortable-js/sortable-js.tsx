                            ...
                            <Row>
                                <Col xl={6}>
                                    <SpkListgroup as="ul" CustomClass="sortable-list" Id="disabling-sorting-left">
                                        <ReactSortable disabled filter=".addImageButtonContainer" dragClass="sortableDrag" list={lists.list3} group={{ name: 'shared', pull: 'clone', put: false }} setList={newList => updateList('list3', newList)} animation={200} easing="ease-out">
                                ...
                                <Col xl={6}>
                                    <SpkListgroup as="ul" CustomClass="sortable-list" Id="disabling-sorting-right">
                                        <ReactSortable disabled filter=".addImageButtonContainer" dragClass="sortableDrag" list={lists.list4} setList={newList => updateList('list4', newList)} animation={200} easing="ease-out" group={'shared'}>
