...
const Placeholders = () => {
    return (
        <Fragment>
                    ...
                    <Row>
                        <Col xl={6} lg={6} md={6} sm={12} >
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed rounded m-2">
                        ...
                        <Col xl={12}>
                            <ShowCode title="Animation" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded m-2" reactCode={placeholder1}>
                ...
                <Col xl={6}>
                    <Row>
                        <Col xl={12}>
                            <Row>
                                <Col xl={12}>
                                    <ShowCode title="Sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded m-2 mt-0" reactCode={placeholder2}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Colors" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded m-2 mt-0" reactCode={placeholder3}>
                                <span className="placeholder col-12"></span>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Width" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded m-2 mt-0" reactCode={placeholder4}>
