...
import { Basicdata, Dynamicdata, Effectcovberflowdata, Effectcubedata, Effectflipdata, Customdata, Fractiondata, Keyboarddata, Mousewheeldata, Navigationdata, Paginationdata, Progressdata, Scrollbardata, Thumbdata, Verticaldata } from "../../../shared/data/adavanec-ui/swiperjsdata";
    ...
    return (
        <Fragment>
            ...
            <Row>
                ...
                <Col xl={4} lg={6} md={6} sm={12}>
                    <Card className="custom-card custom-swiper">
                        <Card.Header className=" pb-0">
                            <Card.Title>
                                Vertical Swiper
                            </Card.Title>
                        ...
                        <Card.Body>
                            <SpkSwiperJs slides={Verticaldata} direction={"vertical"} pagination={true} autoplay={true} className="mySwiper vertical custom-verticalSwiper swiper-vertical" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4} lg={6} md={6} sm={12}>
                    <Card className="custom-card custom-swiper">
                        ...
                        <Card.Body>
                            <SpkSwiperJs slides={Mousewheeldata} direction={"vertical"} slidesPerView={1} spaceBetween={30} pagination={true} autoplay={true} className="mySwiper vertical custom-verticalSwiper vertical-mouse-control" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4} lg={6} md={6} sm={12}>
                ...
                <Col xl={4} lg={6} md={6} sm={12}>
                    <Card className="custom-card custom-swiper">
                        ...
                        <Card.Body>
                            <Swiper className="mySwiper swiper-h swiper swiper-horizontal1" spaceBetween={50}>
                                <SwiperSlide><img src={media30} alt="" /></SwiperSlide>
                                <SwiperSlide>
                                    <Swiper className="mySwiper2 swiper-v swiper vertical swiper-vertical1" direction={"vertical"} spaceBetween={50}>
                ...
                <Col xl={4} lg={6} md={6} sm={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <SpkSwiperJs slides={Effectcubedata} spaceBetween={30} cubeEffect={{ shadow: true, slideShadows: true, shadowOffset: 30, shadowScale: 1.94 }} effect={"fade"} navigation={true} pagination={true} autoplay={true} className="mySwiper swiper swiper-fade cube-custom" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4} lg={6} md={6} sm={12}>
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <SpkSwiperJs slides={Thumbdata} navigation={true} autoplay={true} thumb={{ swiper: thumbsSwiper && !thumbsSwiper.destroyed ? thumbsSwiper : null }} className="mySwiper" />
