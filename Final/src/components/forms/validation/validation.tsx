...
const Validation: React.FC<ValidationProps> = () => {
    ...
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Custom Validation" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={validation1}>
                ...
                <Col xl={6}>
                    <ShowCode title="Browser default Validation" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={validation2}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Server side Validation" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={validation3}>
                        <Form className="row g-3">
                            <Col md={4}>
                    ...
                    <ShowCode title="Tooltips" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={validation4}>
                        <Formik validationSchema={schema}  initialValues={{ firstName: "Mark", lastName: "Otto", username: "", city: "", state: "", zip: "", file: null, terms: false, }}
                        >
                ...
                <Col xl={6}>
                    <ShowCode title="Supported elements" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={validation5}>
                        <Form className="was-validated" validated>
                            <div className="mb-3">
                                <Form.Label htmlFor="validationTextarea">Textarea</Form.Label>
                                <Form.Control as="textarea" isInvalid className="" defaultValue={textCheck} id="validationTextarea"
                                    placeholder="Required example textarea" required onChange={(e) => setTextCheck(e.target.value)} ></Form.Control>
                                {textCheck === '' && <Form.Control.Feedback className="invalid-feedback"> Please enter a message in the textarea. </Form.Control.Feedback>}
                            </div>
                            <Form.Check type="checkbox" defaultChecked={checkBox} onChange={(e) => setCheckBox(e.target.checked)} className="form-check mb-3" id="validationFormCheck1"
                                required isInvalid label="Check this checkbox" feedback={checkBox ? '' : 'Example invalid feedback text'} feedbackType={checkBox ? 'valid' : 'invalid'} />
                            <Form.Check type="radio" className="" defaultChecked={radioCheck} onChange={(e) => setRadioCheck(e.target.checked)} id="validationFormCheck2" name="radio-stacked"
                                required isInvalid label="Toggle this radio" />
                            <Form.Check type="radio" className="form-check mb-3" defaultChecked={radioCheck} onChange={(e) => setRadioCheck(e.target.checked)} id="validationFormCheck3" name="radio-stacked"
                                required isInvalid label="Or toggle this other radio" feedback={radioCheck ? '' : 'More example invalid feedback text'} feedbackType={radioCheck ? 'valid' : 'invalid'} />
                            <Form.Group className="mb-3" >
                                <Form.Select className="" defaultValue={select} onChange={(e) => setSelect(e.target.value)} required aria-label="select example" isInvalid>
                                    <option value="">Open this select menu</option>
                                    <option defaultValue="1">One</option>
                                    <option defaultValue="2">Two</option>
                                    <option defaultValue="3">Three</option>
                                </Form.Select>
                                {select === '' && <div className="invalid-feedback" >Example invalid select feedback</div>}
                            </Form.Group>

                            <div className="mb-3">
                                <Form.Control type="file" defaultValue={fileSelect} onChange={(e) => setFileSelect(e.target.value)} aria-label="file example" isInvalid
                                    required />
                                {fileSelect === '' && <Form.Control.Feedback type="invalid">Example invalid form file feedback</Form.Control.Feedback>}
                            </div>
                            <div className="mb-3">
