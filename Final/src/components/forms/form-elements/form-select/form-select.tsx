...
import { MultiGroup, Multipleselectdata, Multipleselectdata1, Optionwithnosearch, SingleGroup } from "../../../../shared/data/forms/formselectdata";
...
const FormSelect: React.FC<FormSelectProps> = () => {
    ...
    const handleKeyDown1 = (event: KeyboardEvent<HTMLInputElement>) => {
    ...
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <Card.Body className="border border-dashed rounded-1 m-2 mt-0">
                            ...
                            <div className="choices mb-4">
                                <SpkMultiselect multi options={Multipleselectdata} mainClass="default basic-multi-select custom-multi "
                                    values={[Multipleselectdata[0]]} onChange={(valuesA) => setValuesA(valuesA)} disabledLabel={defaults.length} />
                            </div>
                            ...
                            <div className="choices mb-4">
                                <SpkMultiselect multi options={Multipleselectdata1} mainClass="basic-multi-select custom-multi"
                                    values={[Multipleselectdata1[0]]} onChange={(valuesB) => setValuesB(valuesB)} />
                            </div>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body id="form-select-unique" className="border border-dashed rounded-1 m-2 mt-0">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title="Default Select" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={formselect2}>
                ...
                <Col xl={4}>
                    <ShowCode title=" Disabled Select" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={formselect7}>
                ...
                <Col xl={4}>
                    <ShowCode title="Rounded Select" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={formselect3}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Multiple Attribute Select" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={formselect9}>
                ...
                <Col xl={6}>
                    <ShowCode title=" Using Size Attribute" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={formselect8}>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Select Sizes" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={formselect4}>
