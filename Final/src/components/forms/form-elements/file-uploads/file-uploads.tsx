...
const FileUploads: React.FC<FileUploadProps> = () => {
    ...
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Bootstrap File Input" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={fileupload1}>
                    ...
                    <Row>
                        <Col xl={12} >
                            <Card className="custom-card">
                                ...
                                <Card.Body className="rounded-1 m-2 mt-0">
