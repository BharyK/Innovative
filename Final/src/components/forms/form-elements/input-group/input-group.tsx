...
const InputGroups: React.FC<InputGroupProps> = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Input Groups" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup1}>
                    ...
                    <ShowCode title="Custom select" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup10}>
                        <InputGroup className="mb-3">
                ...
                <Col xl={6}>
                    <ShowCode title="Multiple inputs" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup6}>
                        <InputGroup>
                    ...
                    <ShowCode title="Checkboxes and radios" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup7}>
                        <InputGroup className="mb-3">
                            <InputGroup.Text className="">
                    ...
                    <ShowCode title="Multiple addons" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup8}>
                        <InputGroup className="mb-3">
                            <InputGroup.Text className="">
                                <Form.Check className="mt-0" type="checkbox" value=""
                                    aria-label="Checkbox for following text input" />
                    ...
                    <ShowCode title="Segmented buttons" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup9}>
                        <div className="input-group mb-3 segmented-custom">
                            <SpkButton Buttontype="button" Buttonvariant="primary" >Action</SpkButton>
                            <SpkDropdown toggleas="a" Togglevariant="" Navigate="#!" Customtoggleclass="btn btn btn-primary dropdown-toggle dropdown-toggle-split no-caret dropdown-toggle rounded-0"
                        ...
                        <InputGroup>
                            ...
                            <SpkButton Buttontype="button" Buttonvariant="primary" >Action</SpkButton>
                            <SpkDropdown toggleas="a" Togglevariant="" Navigate="#!" Customtoggleclass="btn custom-input-group btn btn-primary dropdown-toggle dropdown-toggle-split no-caret dropdown-toggle rounded-0"
                                Arrowicon={true} Menuclass="dropdown-menu" Align="start">
                                <Dropdown.Item href="#!" className="border-bottom-0">Action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Another action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Something else here</Dropdown.Item>
            ...
            <Row>
                <Col xl={6} className="col-xl-6">
                    <ShowCode title="Sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup2}>
                    ...
                    <ShowCode title="Buttons addons" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup3}>
                        <InputGroup className="mb-3">
                ...
                <Col xl={6}>
                    <ShowCode title="Buttons with dropdowns" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup4}>
                        <InputGroup className="mb-3">
                            <SpkDropdown Togglevariant="" Arrowicon={true} Customtoggleclass="btn btn-primary dropdown-toggle no-caret" Toggletext="Dropdown">
                                <Dropdown.Item href="#!" className="border-bottom-0">Action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Another action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Something else here</Dropdown.Item>
                                <Dropdown.Divider>
                        ...
                        <InputGroup className="mb-3">
                            <Form.Control type="text" className="form-control border-end-0" aria-label="Text input with dropdown button" />
                            <SpkDropdown Togglevariant="" Arrowicon={true} Customtoggleclass="btn btn-outline-primary dropdown-toggle no-caret border" Toggletext="Dropdown">
                                <Dropdown.Item href="#!" className="border-bottom-0">Action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Another action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Something else here</Dropdown.Item>
                                <Dropdown.Divider>
                        ...
                        <InputGroup className="flex-nowrap">
                            ...
                            <SpkDropdown Togglevariant="" Arrowicon={true} Customtoggleclass="btn btn-primary-transparent dropdown-toggle no-caret ms-0" Toggletext="Dropdown" >
                                <Dropdown.Item href="#!" className="border-bottom-0">Action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Another action</Dropdown.Item>
                                <Dropdown.Item href="#!" className="border-bottom-0">Something else here</Dropdown.Item>
                                <Dropdown.Divider>
                    ...
                    <ShowCode title="Custom file input" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup5}>
                        <InputGroup className="mb-3">
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Warpping" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={inputgroup11}>
                        <InputGroup className="flex-nowrap">
