        ...
        <Fragment>
            ...
            <Row>
                <Col xl={6} lg={6} md={6} sm={12}>
                    <ShowCode title="Checks" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio1}>
                ...
                <Col xl={6} lg={6} md={6} sm={12}>
                    <ShowCode title="Disabled" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio2}>
                ...
                <Col xl={6} lg={6} md={6} sm={12} >
                    <ShowCode title="Radios" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio3}>
                ...
                <Col xl={6} lg={6} md={6} sm={12} >
                    ...
                    <ShowCode title="Disabled" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio4}>
            ...
            <Row>
                <Col xl={6} lg={6} md={12} sm={12} className="">
                    <ShowCode title="Default (stacked)" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio5}>
                        <Form.Check label="Default checkbox" />
                        <Form.Check disabled label="Disabled checkbox" />
                ...
                <Col xl={6} lg={6} md={12} sm={12} className="">
                    <ShowCode title="Switches" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio6}>
            ...
            <Row>
                <Col xxl={6} xl={12} lg={12} md={12} sm={12}>
                    <ShowCode title="Checkbox Sizes" customCardClass="custom-card" customCardBodyClass="d-sm-flex align-items-center justify-content-between border border-dashed m-2 mt-1" reactCode={radio13}>
                ...
                <Col xxl={6} xl={12} lg={12} md={12} sm={12}>
                    <ShowCode title="Radio Sizes" customCardClass="custom-card" customCardBodyClass="d-sm-flex align-items-center justify-content-between border border-dashed m-2 mt-1" reactCode={radio14}>
                ...
                <Col xxl={5} xl={12} lg={12} md={12} sm={12}>
                    <ShowCode title="Switch Sizes" customCardClass="custom-card" customCardBodyClass="d-sm-flex align-item-center justify-content-between  border border-dashed m-2 mt-1" reactCode={radio15}>
                ...
                <Col xl={4} lg={12} md={12} sm={12}>
                    <ShowCode title="Inline" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio9}>
                ...
                <Col xl={3} lg={12} md={12} sm={12}>
                    <ShowCode title="Without labels" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio10}>
            ...
            <Row>
                <Col xl={6} lg={12} md={12} sm={12}>
                    <ShowCode title="Reverse" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio11}>
                ...
                <Col xl={6} lg={12} md={12} sm={12}>
                    <ShowCode title="Outlined styles" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio12}>
                        <input type="checkbox" className="btn-check" id="btn-check-outlined" />
                        <SpkButton Buttonvariant='outline-primary' Customclass="mb-3 me-2">Single toggle</SpkButton>
            ...
            <Row>
                <Col xl={6} lg={12} md={12} sm={12} className="">
                    <ShowCode title="Radio toggle buttons" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio7}>
                ...
                <Col xl={6} lg={12} md={12} sm={12} className="">
                    <ShowCode title="Checkbox toggle buttons" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio8}>
            ...
            <Row className="row-cols-12">
                <Col md={6} lg={6} className="col col-xl">
                    <ShowCode title="Color Checkboxes" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio20}>
                ...
                <Col md={6} lg={6} className="col col-xl">
                    <ShowCode title="Outline Checkboxes" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio21}>
                        {Checkdata1.map((idx, index) => (
                            <div className={`form-check ${idx.class1}`} key={index}>
                ...
                <Col md={6} lg={6} className="col col-xl">
                    <ShowCode title="Colored Radios" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio22}>
                        {Checkdata1.map((idx, index) => (
                            <div className={`form-check ${idx.class1}`} key={index}>
                ...
                <Col md={6} lg={6} className="col col-xl">
                    <ShowCode title="Outline Radios" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio23}>
                        {Checkdata1.map((idx, index) => (
                            <div className={`form-check ${idx.class1}`} key={index}>
                                <input id={idx.id} className={`form-check-input form-checked-outline form-checked-${idx.class2}`}
                                    type="radio" defaultChecked />
                ...
                <Col md={6} lg={12} className="col col-xl">
                    <ShowCode title="Switches Colors" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio24}>
                        {Checkdata1.map((idx, index) => (
            ...
            <Row>
                <Col xl={6} lg={12} md={12} sm={12}>
                    <ShowCode title="Toggle Switches Style-1" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio16}>
                        <Row className="row gy-1">

                            <Col xl={4}>
                                <div className={`toggle   ${toggles['togglesm'] === 'on' || !toggles['togglesm'] ? 'on' : ''}`} onClick={() => toggle('togglesm')}>
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                                <div className={`toggle mb-3  toggle-secondary ${toggles['default'] === 'on' || !toggles['default'] ? 'on' : ''}`} onClick={() => toggle('default')}>
                                    <span></span>
                                </div>
                            </Col>
                            <Col xl={4}>
                ...
                <Col xl={6} lg={12} md={12} sm={12}>
                    <ShowCode title="Toggle Switches Style-2" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio17}>
            ...
            <Row>
                <Col xl={6} lg={12} md={12} sm={12}>
                    <ShowCode title="Toggle Switch-1 Sizes" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio18}>
                ...
                <Col xl={6} lg={12} md={12} sm={12}>
                    <ShowCode title="Toggle Switch-2 Sizes" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={radio19}>
