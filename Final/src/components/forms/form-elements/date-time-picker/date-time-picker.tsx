...
const DateTimePicker: React.FC<DateTimeProps> = () => {
    ...
    const onChange1 = (dates: Date | null) => {
            ...
            <Row>
                        ...
                        <Card.Body>
                            <div className="form-group mb-0">
                                <div className="input-group datepicker-inputwraper">
                                    <InputGroup.Text className="input-group-text text-muted"> <i className="ri-time-line"></i> </InputGroup.Text>
                                    <SpkDatepickr className="form-control" showTimeSelect dateFormat="h:mm aa" showTimeSelectOnly selected={dates["Timepickerwith24hrFormat"] ? new Date(dates["Timepickerwith24hrFormat"]) : null} onChange={(date: Date | null) => handleDateChange("Timepickerwith24hrFormat", date)} placeholderText="Choose time in 24hr format" />
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                            ...
                            <Form.Group>
                                <InputGroup className="datepicker-inputwraper">
                                    ...
                                    <DatePicker
                                        ...
                                        onChange={(date: Date | null) => setTimeRange(date)} // Ensure this is a single Date
                                        showTimeSelect
                                        showTimeSelectOnly
                ...
                <Col xl={6}>
                    <Card className="custom-card custom-datepicker">
                        ...
                        <Card.Body>
                            <Form.Group>
                                <InputGroup className="datepicker-inputwraper custom-date-picker">
                                    <InputGroup.Text className="input-group-text text-muted"> <i className="ri-time-line"></i> </InputGroup.Text>
                                    <DatePicker
                                        className="form-control"
                                        selected={startDate}
