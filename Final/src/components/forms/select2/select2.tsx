...
const Select2: React.FC<Select2Props> = () => {
    ...
    return (
        <Fragment>
            ...
            {/* <!-- Start::row-1 --> */}
            <div className="alert alert-primary alert-dismissible fs-15 fade show mb-4">
                We Placed <strong className="text-secondary text-decoration-underline">Select2</strong> only in this page by using <strong className="text-secondary text-decoration-underline">jquery</strong> cdn link.
                <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"><i className="bi bi-x"></i></button>
            </div>
            <Row>
                <Col xl={6}>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <SpkMultiselect multi options={Selectoption2} mainClass="default basic-multi-select custom-multi custom-select-dropdown " values={[Selectoption2[0]]} onChange={(valuesA) => setValuesA(valuesA)} />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={6}>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <SpkMultiselect multi options={Selectoption4} mainClass="default basic-multi-select custom-multi custom-select-dropdown " onChange={(valuesB) => setValuesB(valuesB)} placeholder="Select a State" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={6}>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <div className="card-body vstack gap-3">
                            <SpkSelect mainClass="" option={options} classNameprefix="Select2" defaultvalue={singleSelectValue} onfunchange={handleSingleSelectChange} disabled={isSelectDisabled} />
