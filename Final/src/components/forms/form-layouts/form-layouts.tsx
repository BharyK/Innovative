...
const FormLayouts: React.FC<FormLayoutsProps> = () => {
	return (
		<Fragment>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Vertical Forms" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout1}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<ShowCode title="Horizontal form" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout2}>
						<Form>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title=" Vertical Forms with icon" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout7}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<ShowCode title="Horizontal form With Icons" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout8}>
						<Form>
							<Row className="mb-3">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Inline forms" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout3}>
						<Form className="row row-cols-lg-auto g-3 align-items-center">
							...
							<div className="col-12">
								<SpkButton Buttontype="submit" Buttonvariant='primary'>Submit</SpkButton>
							</div>
						</Form>
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Column sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout4}>
						<Row className="g-3">
							<Col sm={7} className="">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Utilities" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout5}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<ShowCode title="Horizontal form label sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout6}>
						<Row className="mb-3">
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Auto sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout9}>
						<Form className="row gy-2 gx-3 align-items-center mb-4">
							...
							<Col className="col-auto">
								...
								<Form.Select className="form-select mb-2" id="autoSizingSelect">
									<option >Choose...</option>
									<option value="1">One</option>
									<option value="2">Two</option>
									<option value="3">Three</option>
							...
							<Col xs="auto">
								<SpkButton Buttontype="submit" Customclass="mb-2">
									Submit
								</SpkButton>
							</Col>
						</Form>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Form grid" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout10}>
						<Row>
							...
							<Col md={12}>
								<SpkButton Buttontype="submit" Buttonvariant='primary'>Sign in</SpkButton>
							</Col>
						</Row>
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Gutters" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={layout11}>
						<Form className="row g-3 mt-0">
							...
							<Col md={6}>
								...
								<Form.Control type="email" className="" id="inputEmail4" placeholder="Email id" />
							</Col>
							<Col md={6}>
								<Form.Label htmlFor="inputPassword4" className="">Password</Form.Label>
								<Form.Control type="password" className="" id="inputPassword4" placeholder="Password" />
							</Col>
							<div className="col-12">
							...
							<Col md={4}>
								...
								<Form.Select id="inputState" className="form-select-lg state">
									<option>Choose...</option>
									<option>...</option>
								</Form.Select>
							</Col>
