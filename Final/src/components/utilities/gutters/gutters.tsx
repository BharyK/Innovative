...
const Gutters = () => {
    return (
        <Fragment>
            ...
            <Pageheader title="Utilities" currentpage="Gutters" activepage="Gutters" />
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                            <p><span className="text-danger">.gx-*</span> classes can be used to control the
                                horizontal gutter widths. The <span className="text-danger">.container </span> or <span className="text-danger">.container-fluid</span> parent may need to be
                            ...
                            <div className="container px-4 mb-3">
                                <div className="row gx-5">
                                    <div className="col">
                                        <div className="p-3 border bg-light mb-2">Custom column padding</div>
                                    </div>
                                    <div className="col">
                                        <div className="p-3 border bg-light mb-2">Custom column padding</div>
                                    </div>
                        ...
                        <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                            <p>The gutters between columns in our predefined grid classes can be removed
                                ...
                                <span className="text-danger">.g-0</span>. This removes the negative <span
                                    className="text-danger">margins</span> from <span className="text-danger">.row </span> and the horizontal <span className="text-danger">padding </span> from all immediate children columns.
                            </p>
