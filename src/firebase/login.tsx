...
const Signin = () => {
  ...
  const handleSignIn = async (event: React.MouseEvent) => {
    ...
    try {
      ...
      const response = await postApi("UserProfile/login", payload);
      ...
      //   return;
      // }
      console.log ("Login successful with email:", email1,password1);
     ...
     navigate(`${import.meta.env.BASE_URL}dashboards/sales/`);
      ...
      toast.error(error.response.data.message, { autoClose: 1500 }); // ✅ added
    } finally {
      setLoading1(false);
    }
  };
  ...
  const firebaseLogin = async (e: React.MouseEvent) => {
    ...
    try {
      await postApi("/api/auth/login", data);
      toast.success("Firebase login successful", { autoClose: 1500 });
    } catch (err) {
                    ...
                    <Card.Body className="p-5">
                      ...
                      <Form onSubmit={handleMockLogin}>
                        <Row className="gy-3">
                          ...
                          <Col xl={12} className="mb-2">
                            ...
                            <div className="position-relative">
                              ...
                              >
                                <i
                                  className={`ri-${showPassword ? "eye-line" : "eye-off-line "} mt-1 align-middle`}
                                ></i>
                              </Link>
                            </div>
                            <div className="mt-2">
                              <div className="form-check">
                                ...
                                />
                                <label
                                  className="form-check-label fw-normal fs-13"
                        ...
                        <button
                          ...
                          disabled={loading1}
                          className="btn-wave btn btn btn-primary btn-lg w-100"
                        >
                          {loading1 && (
                      ...
                      <div className="text-center mt-2">
                        <p className="text-muted">
                          ...
                          <Link
                            to={`${import.meta.env.BASE_URL}authentication/sign-up/sign-up-basic`}
                      ...
                      <div className="d-flex align-items-center justify-content-between gap-3 mb-3 flex-wrap">
                        <SpkButton
                          Buttonvariant=""
                          Customclass="btn primary-dash-border auth-google-icon btn-lg  border d-flex align-items-center justify-content-center flex-fill"
                        >
                        ...
                        <SpkButton
                          Buttonvariant=""
                          Customclass="btn secondary-dash-border auth-facebook-icon btn-lg  border d-flex align-items-center justify-content-center flex-fill"
                        >
                          <span className="avatar avatar-xs">
                        ...
                        <SpkButton
                          Buttonvariant=""
                          Customclass="btn danger-dash-border auth-twitter-icon btn-lg  border d-flex align-items-center justify-content-center flex-fill"
                        >
                          <span className="avatar avatar-xs">
                ...
                <Tab.Pane eventKey="second" className="border-0 p-0">
                  <Card className="custom-card my-4">
                    <Card.Body className="p-5">
                      <p className="h4 mb-2 fw-semibold">Sign In</p>
                      <p className="mb-4 text-muted fw-normal">
                        Welcome back, John! We're glad to see you again!
                      </p>
                      {firebaseError && (
                        ...
                        <Row className="gy-3">
                          ...
                          <Col xl={12} className="mb-2">
                            ...
                            <div className="position-relative">
                              ...
                              >
                                <i
                                  className={`ri-${showPassword1 ? "eye-line" : "eye-off-line"} align-middle mt-1`}
                                ></i>
                              </Link>
                            </div>
                            <div className="mt-2">
