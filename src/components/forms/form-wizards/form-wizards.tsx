...
const FormWizards: React.FC<FormWizardProps> = () => {
    ...
    const [key1, setKey1] = useState('first1'); // Active tab state
    ...
    const handleNext1 = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (activeTabForm.checkValidity()) {
            // If valid, move to the next tab
            const nextTabKey = getNextTabKey(key1); // Get next tab key
            setKey1(nextTabKey);
        } else {
            // If invalid, trigger validation errors
            activeTabForm.classList.add('was-validated');
        }
    };
    type TabKey = 'first1' | 'second1' | 'third1' | 'fourth1';

    const getNextTabKey = (currentKey: TabKey): TabKey => {
        switch (currentKey) {
            case 'first1':
                return 'second1';
            case 'second1':
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="form-wizard1 border border-dashed m-2 mt-0 rounded-1 p-0">
                        ...
                        <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                            <div id="basicwizard">
                                <Tab.Container id="left-tabs-example" defaultActiveKey="first" activeKey={key1} onSelect={setKey1}>
                                    <Nav className="nav nav-tabs nav-justified flex-md-row flex-column mb-4 tab-style-6 p-0 gap-2">
                                        <Nav.Item data-target-form="#contactDetailForm">
                                            <Nav.Link eventKey="first1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1 bg-light m-0" data-bs-toggle="tab" data-toggle="tab" href="#contactDetail"><span>Contact Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item data-target-form="#jobDetailForm">
                                            <Nav.Link eventKey="second1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1 bg-light m-0" data-bs-toggle="tab" data-toggle="tab" href="#jobDetail"><span>Job Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item data-target-form="#educationDetailForm">
                                            <Nav.Link eventKey="third1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1 bg-light m-0" data-bs-toggle="tab" data-toggle="tab" href="#educationDetail"><span>Education Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="fourth1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1 bg-light m-0" data-bs-toggle="tab" data-toggle="tab" href="#finish"><span>Finish</span></Nav.Link>
                                        </Nav.Item>
                                    </Nav>
                                    <Tab.Content>
                                                    ...
                                                    <div className="text-center p-4">
                                                        ...
                                                        <div className="mb-0">
                                                            <div className="form-check d-inline-block">
                                                                <input className="form-check-input" id="customCheck1" required type="checkbox" /> <label className="form-check-label" htmlFor="customCheck1" >I agree with the <Link className="fw-medium text-decoration-underline" to={`${import.meta.env.BASE_URL}pages/terms-conditions`}>Terms and Conditions.</Link></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="d-flex wizard justify-content-between mt-3 flex-wrap gap-2">
                                            <div className="first">
                                                <Link to="#!" className="btn btn-light" onClick={() => setKey1('first1')}>
                                                    First
                                                </Link>
                                            </div>
                                            <div className="d-flex flex-wrap gap-2">
                                                <div className="previous me-2">
                                                    <Link to="#!" className="btn icon-btn btn-primary" onClick={handlePrevious1}>
                                                        <i className="bx bx-left-arrow-alt me-2"></i>Back To Previous
                                                    </Link>
                                                </div>
                                                <div className="next">
                                                    <Link to="#!" className="btn icon-btn btn-secondary" onClick={handleNext1}>
                                                        Next Step<i className="bx bx-right-arrow-alt ms-2"></i>
                                                    </Link>
                                                </div>
                                            </div>
                                            <div className="last">
                                                <Link to="#!" className="btn btn-success" onClick={() => setKey1('fourth1')}>
                                                    Finish
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <Tab.Container id="left-tabs-example" defaultActiveKey="first" activeKey={key} onSelect={handleTabSelect}>
                                    ...
                                    <Tab.Content className="">
                                            ...
                                            <div className="row d-flex justify-content-center">
                                                <div className="col-lg-10">
                                                    <div className="text-center p-4">
                                                        ...
                                                        <div className="mb-0">
                                                            <div className="form-check d-inline-block">
                                                                <input className="form-check-input" id="customCheck2" required type="checkbox" /> <label className="form-check-label" htmlFor="customCheck2">I agree with the <Link className="fw-medium text-decoration-underline" to={`${import.meta.env.BASE_URL}pages/terms-conditions`}>Terms and Conditions.</Link></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="d-flex wizard justify-content-between mt-3 flex-wrap gap-2">
                                            ...
                                            <div className="d-flex flex-wrap gap-2">
                                                <div className="previous me-2">
                                                    <Link to="#!" className="btn icon-btn btn-primary" onClick={handlePrevious}>
                                                        <i className="bx bx-left-arrow-alt me-2"></i>Back To Previous
                                                    </Link>
                                                </div>
                                                <div className="next">
                                            ...
                                            <div className="last">
                                                <Link to="#!" className="btn btn-success" onClick={() => setKey('fourth')}>
                                                    Finish
                                                </Link>
                                            </div>
                                        </div>
