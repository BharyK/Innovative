...
import { floating1, floating2, floating3, floating4, floating5, floating6, floating7 } from "../../../shared/data/prism-code/forms-prism";
...
const FloatingLabels: React.FC<FloatingLabelsProps> = () => {
    return (
        <Fragment>
            {/* <!-- Page Header --> */}
            <Seo title="Forms-Floatinglabels" />
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic Examples" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating1}>
                        <FloatingLabel
                ...
                <Col xl={6}>
                    <ShowCode title="Readonly plain text" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating2}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Floating Labels With Pre Defined Values" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating3}>
                        <Form.Floating className="mb-3">
                ...
                <Col xl={6}>
                    <ShowCode title="Textareas" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating4}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Floating Labels In Select" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating5}>
                ...
                <Col xl={6}>
                    <ShowCode title="Floating Labels With Layouts" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating6}>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Floating Label Colors" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={floating7}>
                        <Row className="gy-4">
                            <Col xl={4} className="">
