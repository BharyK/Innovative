...
const Inputs: React.FC<InputsProps> = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Input Types" customCardClass="custom-card" customCardBodyClass=" border border-dashed rounded-1 m-2 mt-0" reactCode={input1}>
                        <Row className="gy-4">
                            ...
                            <Col xl={6} lg={6} md={6} sm={12}>
                                <Row>
                                    <Col xl={3} className="custom-color">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Input shapes" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input2}>
                ...
                <Col xl={6}>
                    <ShowCode title="Input border Styles" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input3}>
                        <div className="row gy-3">
                            <Col xl={12}>
            ...
            <div className="row">
                <Col xl={12}>
                    <ShowCode title="Input Sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input4}>
                ...
                <Col xl={12}>
                    <ShowCode title="Disabled forms" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input8}>
                        <Form>
                            <fieldset disabled>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Overview" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input5}>
                        <Form>
                            <div className="mb-3">
                ...
                <Col cx={6}>
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Form text" customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input6}>
                        ...
                        <Col xl={12}>
                            <ShowCode title=" Inline text can use any typical inline HTML element with nothing more
                                                than
                                                the <span class='text-danger'>.form-text</span> class." customCardClass="custom-card" customCardBodyClass="border border-dashed rounded-1 m-2 mt-0" reactCode={input7}>
