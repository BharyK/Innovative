...
import { avaialabilityTagOptions, brandTagOptions, categoryTagOption, colorTagOptions, defaultContent, genderTagOption, productTagOptions, PublishedStatusTagOptions, sizeTagOptions, subCategoryTagOptions } from "../../../../shared/data/apps/ecommerce/editproductsdata";
...
const EditProducts = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader title="Apps" subtitle="Ecommerce" currentpage="Edit Product" activepage="Edit Product " />
            {/* <!-- Page Header Close --> */}
                ...
                <Col xl={12}>
                    <Card className="custom-card p-0">
                        <Card.Header className="border-bottom justify-content-between">
                            ...
                            <SpkButton Buttonvariant="secondary" Customclass="btn">Edit Product
                        ...
                        <Card.Body className="py-0">
                            <Row>
                                <Tab.Container defaultActiveKey="first">
                                    <Col xxl={3} xl={4}>
                                        <Nav className="nav flex-column nav-pills add-product-details-nav pt-3" role="tablist">
                                            <Nav.Item className="m-1" role="presentation">
                                                <Nav.Link eventKey="first" className="d-inline-flex w-100 mb-3 gap-2 align-items-center"
                                                    ...
                                                    <div>
                                                        <p className="mb-1 fs-15">Basic Information</p>
                                            ...
                                            <Nav.Item className=" m-1" role="presentation">
                                                <Nav.Link eventKey="second" className="d-inline-flex w-100 gap-2 mb-3" id="images-tab"
                                                    ...
                                                    <div>
                                                        <p className="mb-1 fs-15">Product Images</p>
                                                        <span className="text-muted fs-13">Add Product Images</span>
                                                    </div>
                                                </Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item className="m-1" role="presentation">
                                                <Nav.Link eventKey="third" className="nav-link d-inline-flex w-100 gap-2 mb-3" id="notification-tab"
                                                    ...
                                                    <div>
                                                        <p className="mb-1 fs-15">Pricing</p>
                                            ...
                                            <Nav.Item className=" m-1" role="presentation">
                                                <Nav.Link eventKey="fourth" className="d-inline-flex w-100 mb-3 gap-2" id="security-tab"
                                                    ...
                                                    <div>
                                                        <p className="mb-1 fs-15">Specification</p>
                                                        <span className="text-muted fs-13">Add Product Specification</span>
                                                    </div>
                                                </Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item className="m-1" role="presentation">
                                                <Nav.Link eventKey="fifth" className="nav-link d-inline-flex w-100 mb-0 gap-2" id="otherinfo-tab"
                                                    ...
                                                    <div>
                                                        <p className="mb-1 fs-15">Other Information</p>
                                    ...
                                    <Col xxl={9} xl={8} className="edit-product-content">
                                            ...
                                            <Tab.Content className="p-3 border-bottom border-block-end-dashed">
                                                <Tab.Pane eventKey="first" className="show p-0 border-0" id="account-pane"
                                                    ...
                                                    <Row className="gy-3">
                                                        <Col xl={12}>
                                                            ...
                                                            <Form.Control type="text" className="" id="product-name-add" placeholder="Name" defaultValue="Red Sweat Shirt" />
                                                            <Form.Label htmlFor="product-name-add" className="form-label mt-1 fs-12  text-muted mb-0">*Product Name should not exceed 30 characters</Form.Label>
                                                        </Col>
                                                        <Col xl={6}>
                                                        ...
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-category-add" className="">Sub Category</Form.Label>
                                                        ...
                                                        <Col xl={12}>
                                                            ...
                                                            <Form.Label htmlFor="product-description-add" className="form-label mt-1 fs-12  text-muted mb-0">*Description should not exceed 500 letters</Form.Label>
                                                        </Col>
                                                    </Row>
                                                </Tab.Pane>
                                                <Tab.Pane eventKey="second" className="p-0 border-0" id="images-tab-pane"
                                                    ...
                                                    <div
                                                        ...
                                                        <SpkButton Buttonvariant="secondary" Customclass="btn">Add Product<i
                                                            className="bi bi-plus-lg ms-2"></i></SpkButton>
                                                    </div>
                                                ...
                                                <Tab.Pane eventKey="third" className="p-0 border-0" id="notification-tab-pane"
                                                    ...
                                                    <Row className="gy-3">
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Enter Actual Price</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="product-cost-add" placeholder="Cost" defaultValue="$135.00" />
                                                        </Col>
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Enter Dealer Price</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="product-cost-add" placeholder="Cost" defaultValue="$159.00" />
                                                        </Col>
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Discount Type</Form.Label>
                                                            <Row className="gy-3">
                                                                <Col xll={4}>
                                                                    <Card className="custom-card mb-0 border card-style-6">
                                                                        <Card.Body className="px-3 py-2">
                                                                            <div className="d-flex gap-1 align-items-center justify-content-between mb-0 flex-wrap">
                                                                                <div className="flex-grow-1">
                                                                                    No Discount
                                                                                </div>
                                                                                <div className="min-w-fit-content">
                                                                                    <div className="d-flex gap-2">
                                                                                        <input className="form-check-input m-0" type="radio" id="address1" name="default-address" defaultChecked />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </Card.Body>
                                                                    ...
                                                                    <Card className="custom-card border mb-0 card-style-6">
                                                                        <Card.Body className="px-3 py-2">
                                                                            <div className="d-flex gap-1 align-items-center justify-content-between mb-0 flex-wrap">
                                                                                ...
                                                                                <div className="min-w-fit-content">
                                                                                    <div className="d-flex gap-2">
                                                                                        <input className="form-check-input m-0" type="radio" id="address2" name="default-address" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </Card.Body>
                                                        ...
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Discount Percentage</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="product-discount" placeholder="Discount in %" defaultValue="0.5%" />
                                                        </Col>
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Stock Quantity</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="Stock-quantity" placeholder="Enter Quanity" defaultValue="30 Items" />
                                                        </Col>
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Shipping Cost</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="shiping-cost" placeholder="Enter Shipping Cost" defaultValue="$35.00" />
                                                        </Col>
                                                        <Col xl={12}>
                                                            <Form.Label htmlFor="product-cost-add" className="">Availability Status</Form.Label>
                                                ...
                                                <Tab.Pane eventKey="fourth" className="p-0 border-0" id="security-tab-pane" role="tabpanel"
                                                    ...
                                                    <Row className="gy-3">
                                                        <Col xl={6}>
                                                            ...
                                                            <Form.Control type="text" className="form-control" id="product-type" placeholder="Type" defaultValue="Shirt" />
                                                        </Col>
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-discount" className="">Item Weight</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="product-discount1" placeholder="Weight in gms" defaultValue="250gm" />
                                                        </Col>
                                                        <Col xl={12}>
                                                ...
                                                <Tab.Pane eventKey="fifth" className="p-0 border-0" id="otherinfo-tab-pane" role="tabpanel"
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-1">
                                                        <div className="fw-semibold d-block fs-15">Product Shipping & Handling :</div>
                                                        <SpkButton Buttonvariant="secondary" Customclass="btn">Add Product<i className="bi bi-plus-lg ms-2"></i></SpkButton>
                                                    </div>
                                                    <Row className="gy-3">
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-type" className="">Packaging Type</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="product-type" placeholder="Type" defaultValue="Primary Packaging" />
                                                        </Col>
                                                        <Col xl={6}>
                                                            <Form.Label htmlFor="product-discount" className="">Packaging Details</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="Packaging-Details" placeholder="Enter Packaging Details" defaultValue="Comes in a reusable garment bag" />
                                                        </Col>
                                                        <Col xl={12}>
                                                            <Form.Label className="">Handling Instructions</Form.Label>
                                                            <textarea className="form-control" id="product-description-add" rows={2} defaultValue="Handle with care. Store in a cool, dry place away from direct sunlight."></textarea>
                                                        </Col>
                                                                    ...
                                                                    <Card className="custom-card mb-0 border card-style-6">
                                                                        <Card.Body className="px-3 py-2">
                                                                            <div className="d-flex align-items-center justify-content-between mb-0 flex-wrap">
                                                                                ...
                                                                                <div className="min-w-fit-content">
                                                                                    <div className="d-flex gap-2">
                                                                                        <input className="form-check-input m-0" type="radio" id="address2" name="default-address1" defaultChecked />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </Card.Body>
                                                                    ...
                                                                    <Card className="custom-card border mb-0 card-style-6">
                                                                        <Card.Body className="px-3 py-2">
                                                                            <div className="d-flex align-items-center justify-content-between mb-0 flex-wrap">
                                                                                ...
                                                                                <div className="min-w-fit-content">
                                                                                    <div className="d-flex gap-2">
                                                                                        <input className="form-check-input m-0" type="radio" id="address2" name="default-address1" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </Card.Body>
                                                        ...
                                                        <Col xl={5} className="product-documents-container">
                                                            ...
                                                            <Form.Control type="text" className="form-control" id="product-shipping" placeholder="Enter Shipping Restrictions" defaultValue="This product cannot be shipped to P.O. boxes or APO/FPO addresses" />
                                                        </Col>
                                                    </Row>
                                                    ...
                                                    <Row className="gy-3">
                                                        <Col xl={12}>
                                                            <Form.Label htmlFor="product-type" className="">Return Policy</Form.Label>
                                                            <Form.Control type="text" className="form-control" id="Return-Policy" placeholder="Enter Return Policy" defaultValue="30-day return policy" />
                                                        </Col>
                                                        <Col xl={12}>
                                                            <Form.Label className="">Safety Information</Form.Label>
                                                            <textarea className="form-control" id="product-description-add" rows={2} defaultValue="Warning:Choking hazard. Not suitable for children under 3 years."></textarea>
                                                        </Col>
                                                        <Col xl={12}>
