                        ...
                        >
                          ...
                          <Row className="gy-3">
                            ...
                            <Col xl={12} className="text-start">
                              <Form.Label htmlFor="purchase-desc">
                        ...
                        >
                          ...
                          <Col xl={12} className="text-start">
                            ...
                            <textarea
                              className="form-control"
                              rows={4}
                              value={generalData.registeredAddress}
                              onChange={(e) =>
                                handleGeneralChange(
                                  "registeredAddress",
                                  e.target.value,
                          ...
                          <Col xl={12} className="text-start mt-4">
                            ...
                            <textarea
                              className="form-control"
                              rows={4}
                              value={generalData.billingAddress}
                              onChange={(e) =>
                                handleGeneralChange(
                                  "billingAddress",
                                  e.target.value,
                          ...
                          <Col xl={12} className="text-start mt-4">
                            ...
                            <textarea
                              className="form-control"
                              rows={4}
                              value={generalData.shippingAddress}
                              onChange={(e) =>
                                handleGeneralChange(
                                  "shippingAddress",
                                  e.target.value,
                          ...
                          <Col xl={12} className="text-start mt-4">
                            ...
                            <textarea
                              className="form-control"
                              rows={4}
                              value={generalData.paymentTerms}
                              onChange={(e) =>
                                handleGeneralChange(
                                  "paymentTerms",
                                  e.target.value,
