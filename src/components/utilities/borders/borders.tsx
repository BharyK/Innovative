...
const Borders = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Borders" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border1}>
                ...
                <Col xl={6}>
                    <ShowCode title="Remove borders" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border2}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Border Widths" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border3}>
                ...
                <Col xl={6}>
                    <ShowCode title="Border colors" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border4}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Border color Styling" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border5}>
                        <div className="mb-4">
                ...
                <Col xl={6}>
                    <ShowCode title="Border with opacity" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border6}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Border Radius" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border7}>
                ...
                <Col xl={6}>
                    <ShowCode title="Sizes" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={border8}>
