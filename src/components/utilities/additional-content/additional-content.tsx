                    ...
                    <Row>
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 d-sm-flex">
                        ...
                        <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                            ...
                            <div
                                ...
                                <div className="h-25 d-inline-block"
                                    style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)", paddingInline: "10px" }}
                                >Height 25%
                                </div>
                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1">
                                    ...
                                    <p className="pe-none mb-0"><a href="#!" tabIndex={-1} aria-disabled="false"><code>This link</code></a>
                                        ...
                                        <code className="mx-1">pe-auto</code> class and can be clicked.
                                    </p>
                                </Card.Body>
                            </Card>
                        </Col>
            ...
            <Row>
                <Col xl={6}>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="border border-dashed m-2 mt-0 rounded-1 d-md-flex">
