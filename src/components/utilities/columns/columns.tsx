...
import media48 from '../../../assets/images/media/media-40.jpg';
...
const Columns = () => {
    return (
        <Fragment>
            ...
            <Pageheader title="Utilities" currentpage="Columns" activepage="Columns" />
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-row bd-example-row-flex-cols">
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-row">
                                    <div className="container">
                                        <Row>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-row">
                                    ...
                                    <p>There are also responsive <span className="text-danger me-1">.order-first</span> and
                                        <span className="text-danger me-1 mx-1">.order-last</span> classes that change the
                                        order of an element by applying <span className="text-danger me-1">order: -1</span> and
                                        <span className="text-danger mx-1 me-1">order: 6</span>, respectively. These
            ...
            <Row>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        <Card.Body className="border border-dashed m-2 rounded-1">
                            <p>The classes can be used together with utilities to create responsive floated
                                images.
                                Make sure to wrap the content in a <span className="text-danger me-1">.clearfix </span>
                                wrapper to clear the float if the text
                                is shorter.</p>
                            <div className="clearfix">
                                <img src={media48} className="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="..." />
                                <p>
