                    ...
                    <Row>
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <div
                                    className="card-body border border-dashed m-2 mt-0 rounded-1 bd-example-position-examples d-flex justify-content-around">
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-position-examples">
