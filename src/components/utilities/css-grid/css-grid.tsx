                    ...
                    <Row>
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-cssgrid text-center">
                                    <div className="grid">
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-cssgrid">
                                    ...
                                    <div className="grid mb-3 text-center gap-3">
                                        <div className="g-col-6">.g-col-6</div>
                                        <div className="g-col-6">.g-col-6</div>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-cssgrid text-center">
                                    ...
                                    <div className="grid mb-3 column-gap-3"
                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="border border-dashed m-2 mt-0 rounded-1 bd-example-cssgrid text-center nesting-grid-reponsive">
                                    <div className="grid"
