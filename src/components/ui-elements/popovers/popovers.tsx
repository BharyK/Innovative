...
const Popovers = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={5}>
                    <ShowCode title="Default Popovers" customCardClass="custom-card" customCardBodyClass=" border border-dashed m-2 mt-0 rounded-1" dataCode={datapopover1} reactCode={popovers1} reusableCode={reusablepopover1}>
                ...
                <Col xl={7}>
                    <ShowCode title="Colored Headers" customCardClass="custom-card" customCardBodyClass=" border border-dashed m-2 mt-0 rounded-1" dataCode={datapopover2} reactCode={popovers2} reusableCode={reusablepopover2}>
                        <div className="btn-list">
                            {Colorheaderalerts.map((idx, index) => (
                                <SpkPopovers trigger="click" placement={idx.class} key={index} popoverClass={`header-${idx.color1} ${idx.color2}`} title="Color Header" content={`Popover with ${idx.color1} header.`} data-bs-custom-classname={`header-${idx.color1}`}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Colored Popovers" customCardClass="custom-card" customCardBodyClass=" border border-dashed m-2 mt-0 rounded-1" dataCode={datapopover3} reactCode={popovers3} reusableCode={reusablepopover3}>
                        <div className="btn-list custom-btn-active">
                            {Colredalerts.map((idx, index) => (
                                <SpkPopovers trigger="click" placement={idx.class} key={index} popoverClass={`popover-${idx.color1}`} title="Color Background" content={`Popover with ${idx.text} background.`}>
                ...
                <Col xl={6}>
                    <ShowCode title="Light Popovers" customCardClass="custom-card" customCardBodyClass=" border border-dashed m-2 mt-0 rounded-1" dataCode={datapopover3} reactCode={popovers4} reusableCode={reusablepopover4}>
                        <div className="btn-list">
                            {Colredalerts.map((idx, index) => (
                                <SpkPopovers trigger="click" placement={idx.class} key={index} popoverClass={`popover-${idx.color1}-light`} title="Light Background" content={`Popover with light ${idx.text} background.`}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Dismissible Popovers" customCardClass="custom-card mb-5" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1 d-flex flex-wrap justify-content-between custom-btn-active" reactCode={popovers7} reusableCode={reusablepopover7} >
                        {Dismissiblealerts.map((idx, index) => (
                            <SpkPopovers trigger="click" rootClose={true} placement={idx.class} key={index} title="Dismissible Popover" content={`And here's some amazing content. It's very engaging. ${idx.class}?`}>
                ...
                <Col xl={3}>
                    <ShowCode title="Disabled Popover" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={popovers5} reusableCode={reusablepopover5}>
                ...
                <Col xl={3}>
                    <ShowCode title="Icon Popovers" customCardClass="custom-card" customCardBodyClass="m-2 mt-0 border border-dashed" reactCode={popovers6} reusableCode={reusablepopover6}>
