...
import { Animatedata, Coloreddata, CustomProgress2data, Heightdata, Multipleprogress, Stripeddata, progressdata } from "../../../shared/data/ui-elements/progressdata";
...
const Progress: React.FC<ProgressProps> = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic Progress" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress1} reusableCode={reusableprogress1}>
                        {progressdata.map((idx, index) => (
                            <SpkProgress key={index} variant="primary" now={idx.data} mainClass={`progress ${idx.maincustomClass}`} />
                        ))}
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Different Colored Progress" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress6} reusableCode={reusableprogress6}>
                        {Coloreddata.map((idx, index) => (
                            <SpkProgress key={index} variant={idx.color} now={idx.data} mainClass={`progress ${idx.maincustomClass}`} />
                        ))}
                    </ShowCode>
                </Col>
            </Row>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Striped Progress" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress2} reusableCode={reusableprogress2}>
                        {Stripeddata.map((idx, index) => (
                            <SpkProgress key={index} variant={idx.color} striped={true} now={idx.data} mainClass={`progress ${idx.maincustomClass}`} />
                        ))}
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Progress Height" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress5} reusableCode={reusableprogress5}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Progress With Labels" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress3} reusableCode={reusableprogress3}>
                        {Stripeddata.map((idx, index) => (
                            <SpkProgress key={index} variant={idx.color} label={`${idx.data}%`} now={idx.data} mainClass={`progress ${idx.maincustomClass}`} />
                        ))}
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Multiple bars With Sizes" customCardClass="custom-card" customCardBodyClass="progress-body" dataCode={dataprogress4} reactCode={progress4} reusableCode={reusableprogress4}>
                        {Multipleprogress.map((idx, index) => (
                            <ProgressBar className={`progress-stacked progress-${idx.size} ${idx.maincustomClass}`} key={index}>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Animated Stripped Progress" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress13} reusableCode={reusable13}>
                        {Animatedata.map((idx, index) => (
                            <SpkProgress key={index} variant={idx.color} mainClass={`progress ${idx.class}`} animated={true} now={idx.data} />
                        ))}
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Gradient Progress" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress12} reusableCode={reusableprogress12}>
                        {Animatedata.map((idx, index) => (
                            <SpkProgress key={index} variant={`${idx.color}-gradient`} mainClass={`progress ${idx.class}`} animated={true} now={idx.data} />
                        ))}
                    </ShowCode>
                </Col>
            </Row>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Custom Animated Progress" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress14} reusableCode={reusableprogress14}>
                        {Animatedata.map((idx, index) => (
                            <SpkProgress key={index} variant={`${idx.color}-gradient`} mainClass={`progress progress-animate ${idx.class}`} animated={true} now={idx.data} />
                        ))}
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Custom Progress-1" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress7}>
                        ...
                        <div className="progress progress-sm progress-custom mb-2 progress-animate">
                            <h6 className="progress-bar-title bg-danger">Shirts</h6>
                            <div className='progress-bar bg-danger custom-height1' style={{ width: "70%" }}>
                                <div className='progress-bar-value bg-danger'>50%</div>
                            </div>
                        </div>
                    </ShowCode>
                </Col>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Custom Progress-2" reactCode={progress8} dataCode={dataprogress8} customCardBodyClass="border border-dashed m-2 mt-0 rounded-1">
                ...
                <Col xl={6}>
                    <ShowCode title="Custom Progress-3" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress9}>
                        <div className="progress progress-lg mb-4 custom-progress-3 progress-animate" role="progressbar">
                        ...
                        <div className="progress progress-lg custom-progress-3 progress-animate" role="progressbar" >
                            <div className="progress-bar bg-danger" style={{ width: "70%" }}>
                                <div className="progress-bar-value danger">70%</div>
                            </div>
                        </div>
                    </ShowCode>
                </Col>
            ...
            <Row>
                ...
                <Col xl={6}>
                    <ShowCode title="Custom Progress-5" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={progress11}>
