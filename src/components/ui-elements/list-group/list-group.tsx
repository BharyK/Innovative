...
const ListGroups = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic List" customCardClass="custom-card" customCardBodyClass="pt-0" dataCode={datalistgroup1} reactCode={Listgroup1} reusableCode={reuseListgroup1}>
                        <SpkListgroup as="ul">
                ...
                <Col xl={6}>
                    <ShowCode title="Active items" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup4} dataCode={datalistgroup4} reusableCode={reuseListgroup4}>
                        <SpkListgroup as="ul">
                ...
                <Col xl={6}>
                    <ShowCode title="Disabled items" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup2} reusableCode={reuseListgroup2}>
                ...
                <Col xl={6}>
                    <ShowCode title="Flush" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup3} reusableCode={reuseListgroup3}>
                        <SpkListgroup Variant='flush'>
                            <ListGroup.Item className="fw-semibold"><i className="ti ti-mail fs-16 align-middle me-2 d-inline-flex text-muted"></i>Asish Trivedhi<span className="ms-1 text-muted fw-normal d-inline-block">(+1023-84534)</span></ListGroup.Item>
                            <ListGroup.Item className="fw-semibold"><i className="ti ti-brand-tiktok fs-16 align-middle me-2 d-inline-flex text-muted"></i>Alezander Russo<span className="ms-1 text-muted fw-normal d-inline-block">(+7546-12342)</span></ListGroup.Item>
                            <ListGroup.Item className="fw-semibold"><i className="ti ti-brand-whatsapp fs-16 align-middle me-2 d-inline-flex text-muted"></i>Karem Smith<span className="ms-1 text-muted fw-normal d-inline-block">(+9944-56632)</span></ListGroup.Item>
                            <ListGroup.Item className="fw-semibold"><i className="ti ti-brand-facebook fs-16 align-middle me-2 d-inline-flex text-muted"></i>Melissa Brien<span className="ms-1 text-muted fw-normal d-inline-block">(+1023-34323)</span></ListGroup.Item>
                            <ListGroup.Item className="fw-semibold"><i className="ti ti-brand-instagram fs-16 align-middle me-2 d-inline-flex text-muted"></i>Kamala Harris<span className="ms-1 text-muted fw-normal d-inline-block">(+91-63421)</span></ListGroup.Item>
                        </SpkListgroup>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Links" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup6} dataCode={datalistgroup6} reusableCode={reuseListgroup6}>
                        <SpkListgroup>
                ...
                <Col xl={6}>
                    <ShowCode title="buttons" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup5} reusableCode={reuseListgroup5}>
                        <SpkListgroup>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Contextual classes" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup16} dataCode={datalistgroup16} reusableCode={reuseListgroup16}>
                        <SpkListgroup as="ul">
                ...
                <Col xl={6}>
                    <ShowCode title="Contextual classes with hover styles" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup15} dataCode={datalistgroup15} reusableCode={reuseListgroup15}>
                        <ListGroup>
                            {ContextualButtons.map((idx, index) => (
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Solid Colored Lists" customCardClass="custom-card" customCardBodyClass="pt-0" dataCode={datalistgroup14} reactCode={Listgroup14} reusableCode={reuseListgroup14}>
                        <SpkListgroup as="ul">
                            {ContextualButtons.map((idx, index) => (
                ...
                <Col xl={6}>
                    <ShowCode title="Custom content" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup13} dataCode={datalistgroup13} reusableCode={reuseListgroup13}>
                        <SpkListgroup>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Sub headings" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup7} dataCode={datalistgroup7} reusableCode={reuseListgroup7}>
                ...
                <Col xl={6}>
                    <ShowCode title="Numbered Lists" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup8} reusableCode={reuseListgroup8}>
                        <SpkListgroup as="ol" Numbered={true}>
                            <ListGroup.Item as="li">Simply dummy text of the printing.</ListGroup.Item>
                            <ListGroup.Item as="li">There are many variations of passages.</ListGroup.Item>
                            <ListGroup.Item as="li">All the Lorem Ipsum generators.</ListGroup.Item>
                ...
                <Col xl={6}>
                    <ShowCode title="List With Checkboxes" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup9} reusableCode={reuseListgroup9}>
                        <SpkListgroup as="ul">
                ...
                <Col xl={6}>
                    <ShowCode title="List With Radios" customCardClass="custom-card" customCardBodyClass="pt-0" reactCode={Listgroup10} reusableCode={reuseListgroup10}>
                        <SpkListgroup>
                ...
                <Col xl={6}>
                    <ShowCode title="List With badges" customCardClass="custom-card" customCardBodyClass="pt-0" dataCode={datalistgroup11} reactCode={Listgroup11} reusableCode={reuseListgroup11}>
                        <SpkListgroup as="ul">
                ...
                <Col xl={6}>
                    <ShowCode title="Horizontal" customCardClass="custom-card" customCardBodyClass="pt-0 horizontal-listgroup" dataCode={datalistgroup12} reactCode={Listgroup12} reusableCode={reuseListgroup12}>
