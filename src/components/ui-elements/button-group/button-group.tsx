...
const ButtonGroups: React.FC<ButtonGroupProps> = () => {
    return (
        <Fragment>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic example" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup1} reusableCode={reusebtngroup1}>
                        <SpkButtongroup Buttongrplabel="Basic example">
                            <SpkButton Buttonvariant="primary" Buttontype="button"><i className="bi bi-skip-backward"></i></SpkButton>
                            <SpkButton Buttonvariant="primary" Buttontype="button"><i className="bi bi-pause"></i></SpkButton>
                            <SpkButton Buttonvariant="primary" Buttontype="button"><i className="bi bi-skip-forward"></i></SpkButton>
                        </SpkButtongroup>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Navigation" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup3} reusableCode={reusebtngroup3}>
                        <SpkButtongroup>
                ...
                <Col xl={6}>
                    <ShowCode title="Mixed Style" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup6} reusableCode={reusebtngroup6}>
                        <SpkButtongroup Buttongrplabel="Basic mixed styles example">
                            ...
                            <SpkButton Buttonvariant="secondary" Buttontype="button">Right</SpkButton>
                        </SpkButtongroup>
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Outline styled" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup4} reusableCode={reusebtngroup4}>
                ...
                <Col xl={6}>
                    <ShowCode title="Checkbox button groups" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup2} reusableCode={reusebtngroup2}>
                ...
                <Col xl={6}>
                    <ShowCode title=" Radio button groups" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup5} reusableCode={reusebtngroup5}>
                ...
                <Col xl={12}>
                    <ShowCode title="Sizing" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup11} reusableCode={reusebtngroup11}>
                        <SpkButtongroup Size="lg" Customclass="my-1 me-3" Buttongrplabel="Large button group">
                            <SpkButton Buttonvariant="outline-secondary" Buttontype="button">Left</SpkButton>
                            <SpkButton Buttonvariant="outline-secondary" Buttontype="button">Middle</SpkButton>
                            <SpkButton Buttonvariant="outline-secondary" Buttontype="button">Right</SpkButton>
                        </SpkButtongroup>
                ...
                <Col xl={12}>
                    <ShowCode title="Button toolbar" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup8} reusableCode={reusebtngroup8}>
                ...
                <Col xl={6}>
                    <ShowCode title="Nesting" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup9} reusableCode={reusebtngroup9}>
                        <SpkButtongroup Customclass="" Buttongrplabel="Button group with nested dropdown">
                            <SpkButton Buttonvariant="primary" Buttontype="button">1</SpkButton>
                            <SpkButton Buttonvariant="primary" Buttontype="button">2</SpkButton>

                            <DropdownButton as={ButtonGroup} title="Dropdown" id="btnGroupDrop1" className="dropdown-toggle no-caret" >
                ...
                <Col xl={6}>
                    <ShowCode title="Social Group Buttons" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup10} dataCode={datagroup10} reusableCode={reusebtngroup10}>
                        <SpkButtongroup Buttongrplabel="Basic example">
                            {SocialIconButtons.map((idx, index) => (
                                <SpkButton Buttonvariant={idx.class1} Customclass="btn-icon d-flex align-items-center justify-content-center" key={index}>
                ...
                <Col xl={12}>
                    <ShowCode title="Vertical variation" customCardClass="custom-card" customCardBodyClass="border border-dashed m-2 mt-0 rounded-1" reactCode={btngroup7} reusableCode={reusebtngroup7}>
