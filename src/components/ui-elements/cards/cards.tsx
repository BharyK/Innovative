...
import { borderCards } from "../../../shared/data/ui-elements/cardsdata";
...
const Cards = () => {
    ...
    type Breakpoint = 'sm' | 'md' | 'lg' | 'xl' | true | false;

    function handleShow(breakpoint: Breakpoint) {
        ...
        <Fragment>
            ...
            <Row>
                <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                    <SpkCard titleClass="fw-medium" imgClass="card-img-top" imgSrc={media24} title="Card title" bodyText={(
                ...
                <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                    <SpkCard imgClass="card-img-top" imgSrc={media23} bodyText={(
                        <>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </>
                    )}
                    ...
                    <SpkCard bodyText={(<p className="mb-0">It is a long established fact that a reader will be distracted by the readable content.</p>)} />
                </Col>
                <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                    ...
                    />
                    <SpkCard title="Card title" subTitle="Card subtitle" bodyText={(<p className="card-text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration many variations of passages of Lorem Ipsum available there are so many ways to solve but the majority.</p>)}
            ...
            <Row>
                <Col xxl={6} xl={6} lg={12}>
                    ...
                    <div className="row row-cols-12 custom-width">
                        <div className="col">
                            <SpkCard
                                bodyText={(
                                    <>
                                        <img src={media25} className="card-img mb-3" alt="..." />
                                        <h6 className="card-title fw-medium">Product A</h6>
                                        <p className="card-text">With supporting text below as a natural
                                            lead-in to additional content.</p>
                                        <Link to="#!" className="btn btn-primary-light">Purchase</Link>
                                    </>
                                )}
                            />
                        </div>
                            ...
                            <SpkCard
                                bodyText={(
                                    <>
                                        ...
                                        <p className="card-text">With supporting text below as a natural
                                            lead-in to additional content.</p>
                                        <Link to="#!" className="btn btn-secondary-light">Purchase</Link>
                                    </>
                                )}
                            />
                        </div>
                ...
                <Col xxl={6} xl={6} lg={12}>
                    <Row>
                        ...
                        <Col xl={12}>
                            <SpkCard bodyText={(<blockquote className="blockquote mb-0 text-center"> <h6>Goodness isn't about avoiding falls, but about the courage to rise, stronger and kinder, with every stumble.</h6> <footer className="blockquote-footer mt-2 fs-14">Someone famous in <cite title="Source Title">Source Title</cite></footer> </blockquote>)} />
                        </Col>
                        <Col xl={12}>
            ...
            <Row>
                <Col xl={3}>
                    <SpkCard cardClass='text-center' cardHeader="border-bottom-0 pb-0" useDivHeader={true} bodyClass="pt-1"
                        header={(<span className="ms-auto shadow-lg fs-17"><i className="ri-heart-fill text-danger"></i></span>)}
                        bodyText={(
                            <>
                                ...
                                <div className="btn-list">
                                    <SpkButton Buttonvariant="" Customclass=" btn-icon btn-facebook btn-wave waves-effect waves-light">
                                        <i className="ri-facebook-line"></i>
                                    </SpkButton>
                                    <SpkButton Buttonvariant="" Customclass=" btn-icon btn-twitter btn-wave">
                                        <i className="ri-twitter-x-line"></i>
                                    </SpkButton>
                                    <SpkButton Buttonvariant="" Customclass=" btn-icon btn-instagram btn-wave">
                    ...
                    <SpkCard useDivHeader={true}
                        header={(
                            <div className="d-flex align-items-center w-100">
                                ...
                                <SpkDropdown Customclass="ms-auto" Customtoggleclass="btn btn-icon btn-light no-caret" toggleas='a' Navigate="#!" Togglevariant="light" Size='sm' Icon={true} IconClass="fe fe-more-vertical" >
                                    <Dropdown.Item as='li' className="border-0">Week</Dropdown.Item>
                                    <Dropdown.Item as='li' className="border-0">Month</Dropdown.Item>
                                    <Dropdown.Item as='li' className="border-0">Year</Dropdown.Item>
                                </SpkDropdown>
                            </div>
                        )}
                        bodyText={(
                ...
                <Col xl={3}>
                    <SpkCard useDivHeader={true} bodyClass="pt-3" cardHeader="border-bottom-0 pb-0"
                        header={(
                            <div>
                ...
                <div className="col-xl-2 custom-width">
                    <SpkCard bodyText={(
                        <>
                ...
                <div className="col-xl-2 custom-width">
                    <SpkCard bodyText={(
                        <>
                            ...
                            <h6 className="card-title fw-medium mb-3">Nature<SpkBadge variant="light" Customclass="text-dark float-end fs-10">offer</SpkBadge></h6>
                            <p className="card-text">With supporting text below as a natural lead-in.</p>
                        </>
                    )}
                    />
                ...
                <Col xl={4}>
                    ...
                    >
                        <Modal show={fullscreenshow} fullscreen={fullScreen}>
                            <Modal.Header>
                                <Modal.Title className="fs-15 fw-semibold">Card With Fullscreen Button</Modal.Title>
                                <span className="d-flex ms-auto me-2" onClick={fullscreenmodalClose}><i className='ri-fullscreen-line' ></i></span>
                            </Modal.Header>
                            <Modal.Body>
                    ...
                    <Row>
                        <Col xl={6}>
                            <SpkCard header="Using Width 75%" footer="<a href='#!' class='btn btn-primary d-grid'>Button</a>" cardClass="w-75"
                                bodyText={(<div className="card-text"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Id nostrum omnis excepturi consequatur molestiae </div>)} />
                        </Col>
                        <Col xl={6}>
                            <SpkCard header="Using Width 50%" footer="<a href='#!' class='btn btn-primary d-grid'>Button</a>" cardClass="w-50"
                                bodyText={(<div className="card-text">  Lorem ipsum dolor sit amet consectetur adipisicing elit  </div>)} />
                        </Col>
                    </Row>
                </Col>
                <Col xxl={6} xl={12}>
            ...
            <Row>
                <Col xl={4}>
                    <SpkCard imgSrc={media29} imgClass="card-img-top" bodyText={(
                        <>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcB={media28} imgClassB="card-img-bottom" bodyText={(
                        <>
                            <h6 className="card-title fw-medium">Image caps are widely used in Blog's</h6>
                            <p className="card-text mb-3 text-muted">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings.</p>
                            <p className="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcB={media31} imgClassB="card-img rounded-0" header="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>" bodyText={(
                        <>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcA={media32} imgClassA="card-img-top" header="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>" bodyText={(
                        <>
                            <p className="card-text mb-1 text-muted">This is a wider card with supporting text below
                                as
                                a natural lead-in to additional content. This content is a
                ...
                <Col xl={4}>
                    <SpkCard imgSrcB={media30} imgClassB="card-img rounded-0" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>"
                        bodyText={(
                            <>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcC={media33} imgClassC="card-img-bottom"
                        footer={(
            ...
            <Row>
                <Col xl={4}>
                    <Spkimageoverlaycard CustomClass="overlay-card" Imgsrc={media35} Title="Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" CardHeader={true} CardFooter={false} Custombodyclass="text-fixed-white" >
                ...
                <Col xl={4}>
                    <Spkimageoverlaycard CustomClass="overlay-card" Custombodyclass="text-fixed-white" Footertext="Last updated 3 mins ago" Imgsrc={media36} Customfooterclass="text-fixed-white" Overlayclass="over-content-bottom" CardHeader={false} CardFooter={true}  >
                ...
                <Col xl={4}>
                    <Spkimageoverlaycard CustomClass="overlay-card" Title=" Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" Imgsrc={media34} Custombodyclass="text-fixed-white overflow-y-auto" Customfooterclass="text-fixed-white" CardHeader={true} CardFooter={true} Footertext="Last updated 3 mins ago" >
            ...
            <Row>
                <Col xl={4}>
                    <Spkhorizontalcards CardHeader={true} Navigate="" Imgposition="before" Imagesrc={media37} Imgclass="img-fluid rounded-start h-100 w-100" Title="Horizontal Cards" CardFooter={true} Footertext={"Last updated 3 mins ago"} >
                ...
                <Col xl={4}>
                    <Spkhorizontalcards CardHeader={true} Navigate="" Imgposition="after" Imagesrc={media38} Title="Horizontal Cards"  >
                        <h6 className="card-title fw-medium">Horizontal cards are awesome!</h6>
                ...
                <Col xl={4}>
                    <Spkhorizontalcards CardFooter={true} Navigate="" Footertext="Last updated 3 mins ago" Imgposition="after" Imagesrc={media39} >
            ...
            <Row>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="primary" Imgsrc={face11} Title="Adam Smith" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
                </Col>
                <Col xl={3}>
                ...
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="info" Imgsrc={face8} Title="Monica Karen" Value="Pending from 4 days" Textclass="fixed-white" Class="fixed-white" />
                </Col>
                <Col xl={3}>
                ...
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="light" Imgsrc={face13} Title="Jacob Smith" Value="Finished by 24,Nov" Textclass="" Class="text-default" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="dark" Imgsrc={face16} Title="Pope Adam" Value="Completed on 24,may" Textclass="text-white" Class="white" />
                </Col>
            </Row>
            {/* <!-- End::row-9 --> */}
            ...
            <Row>
                <Col xl={12}>
                    <div className="card-group">
                        <SpkCard imgSrcA={media40} imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
                        ...
                        />
                        <SpkCard imgSrcA={media42} imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
                        ...
                        />
                        <SpkCard imgSrcA={media41} imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
            ...
            <Row>
                <Col xl={12}>
                    <div className="row row-cols-1 row-cols-md-4 g-4">
                        <div className="col">
                            <SpkCard imgSrcA={media44} imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <SpkCard imgSrcA={media43} imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <SpkCard imgSrcA={media45} imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <SpkCard imgSrcA={media46} imgClassA="card-img-top" bodyText={(
                                <>
            ...
            <Row>
                <Col xxl={3} xl={12}>
                    <SpkCard imgSrcA={media23} imgClassA="card-img-top" linkTag={true} titleClass="fw-medium mb-0" title="Forests are Awesome." />
                </Col>
                <Col xxl={6} xl={6}>
                    <Row>
                        <Col xxl={12} xl={12}>
                            <SpkCard cardClass="card-bg-secondary" linkTag={true} bodyText={(
                        ...
                        <Col xxl={7} xl={12} className="custom-cardwithimage">
                            <Spkhorizontalcards Linktag={true} Navigate="#!" Imgposition="after" CardFooter={true} Imagesrc={media30} Footertext="Last updated 3 mins ago" >
                                <h6 className="card-title mb-2 fw-medium">Nature is Beautiful ?</h6>
                ...
                <Col xxl={3} xl={6} className="">
                    <SpkCard linkTag={true} imgSrcA={media47} imgClassA="card-img-top" bodyText={(
                        <>
                            <h6 className="card-title fw-medium">Most tropical areas are suitable</h6>
                            <p className="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                        </>
