...
interface Media {
    ...
    size?: string;    // The size of the file (as a string)
    link: string;      // The link associated with the media (likely to trigger an action or show the media)
}

// Define the interface for the event
interface Event1 {
    step?: number;
    time?: string;
    date?: string;
    ...
    right?: boolean; // Optional property
    media?: Media[];
    description1?: string
...
export const SteptimelineData: Event1[] = [
    ...
    },
    {
        ...
        time: '10:15AM',
        date: '2024-10-05',
        description: 'You Commented on Peter Engola post ',
        description1: '#Mother Nature.',
        details: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, repellendus rem rerum excepturi aperiam ipsam.',
        user: {
            name: 'Alicia Mike',
    ...
    },
    {
        ...
        media: [{
            id: 1,
            fileName: '/assets/images/media/file-manager/3.png',
            size: '432.87KB',
            link: '#!',
        }],
        user: {
    ...
    },
    {
        ...
        media: [
            { id: 1, fileName: '/assets/images/media/media-59.jpg', link: '#!' },
            { id: 2, fileName: '/assets/images/media/media-60.jpg', link: '#!' },
            { id: 3, fileName: '/assets/images/media/media-61.jpg', link: '#!' },
        ],
        user: {
            name: 'Alister Chuk',
    ...
    },
    {
        ...
        time: '15:56PM',
        date: '2024-04-15',
        description: 'Social network accounts are at risk check your  Details',
