...
export const Outlinealerts: alert3[] = [
	...
	{ id: 9, text: "A simple outline info alert—check it out! ", class: "outline-info", color: "" },
...
export const Linkalerts: alert2[] = [
	...
	{ id: 3, text1: "A simple danger alert with ", text2: "an example link. ", text3: "Give it a click if you like.", class: "danger" },
	{ id: 4, text1: "A simple warning alert with ", text2: "an example link. ", text3: "Give it a click if you like.", class: "warning" },
	{ id: 5, text1: "A simple success alert with ", text2: "an example link. ", text3: "Give it a click if you like.", class: "success" },
...
export const Defaultsolidalerts: alert5[] = [
	...
	{ id: 2, text: "A simple solid primary alert with normal shadow—check it out! ", class: "primary", size: "lg" },
	...
	{ id: 5, text: "A simple solid secondary alert with normal shadow—check it out!", class: "secondary", size: "lg" },
...
export const Customizedalert1: alert6[] = [
	...
	{ id: 3, class1: "M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z", color: "warning", btnclass: 'custom-close-btn' },
...
export const Svgalert1: alert9[] = [
	...
	{ id: 2, class1: svg2, text1: "Success Alert", text2: "Success alert to show to success message", color: "secondary", btn1: "close", btn2: "", class: "d-none" },
...
export const Svgalert = [
	{ id: 1, class1: Asvg, text1: "Information Alert", text2: "Information alert to show to information", color: "primary", btn1: "cancel", btn2: "open", class: "primary", textcolor: "secondary" },
	{ id: 2, class1: Asvg1, text1: "Success Alert", text2: "Success alert to show to success message", color: "secondary", btn1: "cancel", btn2: "open", class: "secondary", textcolor: "danger" },
	{ id: 3, class1: Asvg2, text1: "Warning Alert", text2: "Warning alert to show warning message", color: "warning", btn1: "cancel", btn2: "open", class: "warning", textcolor: "dark" },
	{ id: 4, class1: Asvg3, text1: "Danger Alert", text2: "Danger alert to show the danger message", color: "danger", btn1: "cancel", btn2: "open", class: "danger", textcolor: "info" },
];
...
export const Additionalcontentalerts: alert10[] = [
	...
	{ id: 3, text1: "Thank you for reporting this.", text2: "We appreciate you to let us know the bug in the template and for warning us about future consequences ", text3: "Visit for support for queries ?", class: "danger" },
