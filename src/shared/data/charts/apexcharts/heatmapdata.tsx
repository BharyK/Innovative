...
data.reverse();
const colors = ["#03b562", "#7f67ff", "#fd4963", "#ffa909", "#0fbcf9", "#00A7C6", "#18D8D8", '#A9D794', '#46AF78', '#A93F55', '#8C5E58', '#2176FF', '#33A1FD', '#7A918D', '#BAFF29']
colors.reverse();
...
export const Heatrangeoptions = {
	...
	colors: ["#0ca3e7", "#b3e9d0", "f4a742", "0ca3e7"],
	title: {
