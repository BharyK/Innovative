...
export interface TableDataItem {
    ...
    LNAME: string;
    POSITION: string;
    START: string; // Assuming it's a string, could be Date if you're storing dates
    SALARY: number;
    MAIL: string;
}
...
export const Definecolumns = [
    ...
    {
        name: 'FIRST NAME',
        selector: (row: TableDataItem) => row.FNAME,
        sortable: true,
    },
    {
        name: 'LAST NAME',
        selector: (row: TableDataItem) => row.LNAME,
        sortable: false,
    },
    {
        name: 'POSITION',
    ...
    {
        name: 'START DATE',
        selector: (row: TableDataItem) => row.START,
        sortable: true,
    },
    {
        name: 'SALARY',
    ...
    {
        name: 'MAIL',
        selector: (row: TableDataItem) => row.MAIL,
        sortable: false,
    },
];

export const Blatantdata = [
    {
        id: '1',
        SNO: 1,
        NAME: 'Yonna',
...
interface DataRow {
    ...
    LASTNAME: string;
    POSITION: string;
    DATE: string; // You can change it to Date if the column holds actual Date objects
    SALARY: number;
    EMAIL: string;
}
...
export const columns1 = [
    ...
    {
        name: 'LAST NAME',
        selector: (row: DataRow) => row.LASTNAME,
        sortable: true,
    },
    {
        name: 'POSITION',
    ...
    {
        name: 'SALARY',
        selector: (row: DataRow) => row.SALARY,
        sortable: true,
    },
    {
        name: 'EMAIL',
