...
export const Basictable: Basic[] = [
    { id: 1, name: "Mark", date: "21,Dec 2021", number: "+1234-12340", status: "Completed", color: "secondary" },
    { id: 2, name: "Monika", date: "29,April 2024", number: "+1523-12459", status: "Failed", color: "danger" },
    { id: 3, name: "Madina", date: "30,Nov 2024", number: "+1982-16234", status: "Successful", color: "primary" },
...
export const Bordertable: Bordertable[] = [
    { id: 1, src: face13, name: "Sukuro Kim", mail: "kimosukuro@gmail.com", color: "primary-transparent ", class: "", text: "Active", class1: "online" },
    { id: 2, src: face6, name: "Hasimna", mail: "hasimna2132@gmail.com", color: "light", class: "text-default", text: "Inactive", class1: "offline" },
    { id: 3, src: face15, name: "Azimo Khan", mail: "azimokhan421@gmail.com", color: "primary-transparent ", class: "", text: "Active", class1: "online" },
    { id: 4, src: face5, name: "Samantha Julia", mail: "	julianasams143@gmail.com", color: "primary-transparent ", class: "", text: "Active", class1: "online" }
];
...
export const Borderdata: Border[] = [
    ...
    { id: 3, name: "Martiana", transactionid: "#5182-3423", date: "15 April 2024", status: "Completed", color: "secondary" },
...
export const Groupdata: Group[] = [
    { id: 1, product: "Smart Watch", seller: "Slowtrack.inc", percent: "	24.23%", sold: "250/1786", icon: "up", color: "secondary" },
    { id: 2, product: "White Sneakers", seller: "American & Co.inc", percent: "12.45%", sold: "123/985", icon: "down", color: "danger" },
    { id: 3, product: "Baseball Bat", seller: "Sports Company", percent: "06.64%", sold: "124/232", icon: "up", color: "secondary" },
    { id: 4, product: "Black Hoodie", seller: "Renonds Fabrics", percent: "14.42%", sold: "192/2456", icon: "up", color: "secondary" },
]
...
const avatar1 = (
    <div className="avatar-list-stacked">
        ...
        <Link className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" to="#!">+5</Link>
    </div>
)
...
const avatar2 = <div className="avatar-list-stacked">
    ...
    <Link className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" to="#!">+6</Link>
</div>
...
const avatar3 = <div className="avatar-list-stacked">
    ...
    <Link className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" to="#!">+2</Link>
</div>
...
export const Hoverable: Hoverable[] = [
    { id: 1, src: face15, name: "Mark Cruise", mail: "markcruise24@gmail.com", date: "Jul 26,2022", text1: "IN-2032", text2: "Paid", color: "primary-transparent", class: "", icon: "check-fill" },
    { id: 2, src: face12, name: "Charanjeep", mail: "charanjeep@gmail.in", date: "Mar 14,2022", text1: "IN-2022", text2: "Paid", color: "primary-transparent", class: "", icon: "check-fill" },
...
export const Warninghead: Warninghead[] = [
    ...
    { id: 4, name: "Alex Carey", date: "17 March 2022", text: "#5182-3456", btn: "Processed", color: "secondary-light" }
];
...
export const Activedata: Active[] = [
    ...
    { id: 2, name: 'Monika', create: "29,April 2022", number: "+1523-12459", status: "Failed", color: "danger", class: "", tdclass: '' },
    { id: 3, name: 'Madina', create: "30,Nov 2022", number: "+1982-16234", status: "Successful", color: "secondary", class: "", tdclass: 'table-active' },
    { id: 4, name: 'Bhamako', create: "18,Mar 2022", number: "+1526-10729", status: "Pending", color: "warning", class: "", tdclass: '' },
]
...
export const Smalltables: Smalltables[] = [
    { id: "1", name: "Zelensky", date: "25-Apr-2021", text: "Paid", class: "primary-transparent", checked: 'defaultChecked', },
    { id: "2", name: "Kim Jong", date: "29-April-2022", text: "Pending", class: "danger-transparent", checked: '', },
    { id: "3", name: "Obana", date: "30-Nov-2022", text: "Paid", class: "primary-transparent", checked: '', },
    { id: "4", name: "Sean Paul", date: "01-Jan-2022", text: "Paid", class: "primary-transparent", checked: '', },
...
const Avatar = <div className="avatar-list-stacked">
    ...
    <span className="avatar avatar-sm avatar-rounded"><img src={face2} alt="img" /></span>
    <Link className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" to="#!">+4</Link>
</div>
...
const Avatar1 = <div className="avatar-list-stacked">
    ...
    <Link className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" to="#!">+4</Link></div>
...
const Avatar2 = <div className="avatar-list-stacked">
    ...
    <Link className="avatar avatar-sm bg-primary text-fixed-white avatar-rounded" to="#!">+10</Link>
</div>
...
export const Responsivedata = [
    ...
    { id: 3, src: face14, name: "Simon Cowel", category: "Service Manager", role: "Manager", color: "primary", team: Avatar2, progress: 45, revenue: "$7,123.21", mail: "simoncowel234@gmail.com" },
