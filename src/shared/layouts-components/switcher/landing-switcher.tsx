...
import { LocalStorageBackup, Reset1, setDirection, setPrimaryColor, ThemePrimaryColor, updateTheme } from '../../data/switcherdata/switcherdata';
...
const LandingSwitcher: FC<LandingSwitcherProps> = ({ show, handleClose }) => {
                    ...
                    <div className="border-0 p-0" id="switcher-home" role="tabpanel"
                        ...
                        <div>
                            ...
                            <div className='text-center'>
                                <Link to="#!" id="reset-all" className="btn btn-danger mt-3" onClick={Reset1} >Reset</Link>
                            </div>
                        </div>
                    </div>
                </OffcanvasBody>
