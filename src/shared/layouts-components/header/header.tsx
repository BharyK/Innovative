      ...
      if (allElement.title.toLowerCase().includes(inputvalue.toLowerCase())) {
        if (
          ...
          if (
            allElement.path &&
            !allElement2.some(
              (el: Menuitemtype) => el.title === allElement.title,
            )
          ) {
      ...
      <header className="app-header sticky" id="header">
        ...
        <div className="main-header-container container-fluid px-0">
          ...
          <div className="header-content-left">
            ...
            <div
              ref={containerRef}
              className="header-element header-search d-md-block d-none my-auto autoComplete_wrapper"
            >
              {/* <!-- Start::header-link --> */}
              <input
                type="text"
              ...
              {showa ? (
                <div
                  className="card custom-card search-result w-100 position-absolute search-fix border border-top-0 "
                  ref={searchResultRef}
                >
          ...
          <ul className="header-content-right">
            ...
            <SpkDropdown
              Align="end"
              Togglevariant=""
              Customclass="header-element country-selector dropdown custom-dropdown"
              toggleas="a"
              Navigate="#!"
              autoClose={true}
              Customtoggleclass="header-link dropdown-toggle border-0 border-start"
              Svgicon={
                <SpkTooltips placement="bottom" title="Language">
                  <svg
              ...
              Svg={true}
              Menuclass="main-header-dropdown dropdown-menu dropdown-menu-end"
            >
              {Languages.map((idx) => (
                <li key={idx.id}>
                  <Link
            ...
            <li className="header-element header-theme-mode">
              ...
              <Link to="#!" className="header-link layout-setting">
                ...
                >
                  {/* <!-- Start::header-link-icon --> */}
                  <SpkTooltips placement="bottom" title="Dark Mode">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="header-link-icon"
                      width="1em"
                ...
                <SpkTooltips placement="bottom" title="Light Mode">
                  <span
            ...
            {/* <!-- Start::header-element --> */}
            <SpkTooltips placement="bottom" title="Download">
              <SpkDropdown
                toggleas="a"
                Align="end"
                Togglevariant=""
                Customtoggleclass="header-link dropdown-toggle no-caret border-0 border-start"
                Customclass="header-element notifications-dropdown d-xl-block d-none dropdown"
                Navigate="#!"
                Id="messageDropdown"
                Svg={true}
                Badgetag={true}
                Badgecolor="pink"
                Badgeclass="header-icon-pulse bg-pink rounded pulse pulse-pink custom-header-icon-pulse"
                Menuclass="main-header-dropdown dropdown-menu dropdown-menu-end"
                Svgicon={
                  <SpkTooltips placement="bottom" title="Notification">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="header-link-icon"
                      width="1em"
              ...
              >
                ...
                <div className="p-3">
                  <div className="d-flex align-items-center justify-content-between">
                    <p className="mb-0 fs-16">
                      Notifications{" "}
                      <span
                        className="badge bg-secondary-transparent ms-1"
                        id="notifiation-data"
                      >
                        20
                      </span>
                    ...
                    >
                      Mark As Read<i className="ri-arrow-right-line ms-1"></i>
                    </a>
                  </div>
                </div>
                ...
                <Tab.Container defaultActiveKey="first">
                  <Nav
                    className="nav nav-tabs nav-tabs-header m-3 p-2 rounded bg-light"
                    role="tablist"
                  >
                  ...
                  <Tab.Content className="border-top">
                          ...
                          <li className="dropdown-item" key={idx.id}>
                            <div className="d-flex align-items-start">
                              <div className="pe-2 lh-1">
                                <span
                                  className={`avatar avatar-md bg-light  ${idx.icon ? "bg-secondary-transparent" : ""} `}
                                >
                                  {idx.icon ? (
                              ...
                              <div className="flex-grow-1 d-flex align-items-start justify-content-between">
                                <div>
                                  ...
                                  {idx.someContent ? (
                                    <div className="p-2 mt-2 rounded bg-light border text-default">
                                      {" "}
                                      Amazing! Fast, to the point,really amazing
                                      to work with them!!!{" "}
                                    </div>
                                  ) : (
                                    ""
                                ...
                                <div>
                                  <p className="mb-0 fs-12 text-muted text-nowrap d-inline-flex align-items-center">
                                    <i
                                      className={`ri-checkbox-blank-circle-fill me-1 fs-8 text-${idx.statusColor}`}
                                    ></i>
                                    {idx.timeAgo}
                                  </p>
                                </div>
                            ...
                            <div className="d-flex align-items-start">
                              ...
                              <div className="flex-grow-1 d-flex align-items-start justify-content-between">
                                <div>
                                  <p className="mb-1">
                                    <a href="#!">
                                      <span className="fw-semibold me-1 d-inline-block">
                                        {idx.user}
                                      </span>
                                      {idx.message}
                                    </a>
                    ...
                    >
                      <SimpleBar
                        className="list-unstyled mb-0"
                        id="header-notification-scroll2"
                      >
                          ...
                          <li className="dropdown-item" key={idx.id}>
                            <div className="d-flex align-items-start">
                              ...
                              <div className="flex-grow-1 d-flex align-items-start justify-content-between">
                                ...
                                <div>
                                  <p className="mb-0 fs-12 text-muted d-inline-flex align-items-center">
                                    <i
                                      className={`ri-checkbox-blank-circle-fill me-1 fs-8 text-${idx.statusColor}`}
                                    ></i>
                                    {idx.timeAgo}
                    ...
                    >
                      <SimpleBar
                        className="list-unstyled mb-0"
                        id="header-notification-scroll3"
                      >
                        {NotificationsInvites.map((idx) => (
                          <li className="dropdown-item" key={idx.id}>
                            <div className="d-flex align-items-start">
                              <div className="pe-2 lh-1">
                                <span
                                  className={`avatar avatar-md bg-${idx.iconBg}-transparent`}
                                >
                              ...
                              <div className="flex-grow-1 d-flex align-items-start justify-content-between">
                                ...
                                <div>
                                  <p className="mb-0 fs-12 text-muted d-inline-flex text-nowrap ms-4 align-items-center">
                                    <i
                                      className={`ri-checkbox-blank-circle-fill me-1 fs-8 text-${idx.statusColor}`}
                                    ></i>
                                    {idx.timeAgo}
                  ...
                  <div className="p-3 empty-header-item1 border-top">
                    <div className="d-grid">
                      <a href="#!" className="btn btn-primary btn-wave">
                        View All
                      </a>
                    </div>
                  </div>
            ...
            {/* <!-- Start::header-element --> */}
            <SpkTooltips placement="bottom" title="Full Screen">
              <li
                className="header-element header-fullscreen"
                title="Full Screen"
              >
                {/* <!-- Start::header-link --> */}
                <Link
                  ...
                  {fullScreen ? (
                    ...
                    >
                      <g
                        ...
                        color="currentColor"
                      >
                        <path d="M2 10.002c.029-3.414.218-5.296 1.46-6.537C4.924 2 7.282 2 11.997 2s7.073 0 8.538 1.465S22 7.287 22 12.003c0 4.715 0 7.073-1.465 8.537c-1.241 1.242-3.123 1.431-6.537 1.46" />
            ...
            {/* <!-- Start::header-element --> */}
            <SpkTooltips placement="bottom" title="User Profile">
              <div>
                <SpkDropdown
                  Align="end"
                  ...
                  Togglevariant=""
                  autoClose={true}
                  Customclass="header-element dropdown custom-dropdown"
                  Imagetag={true}
                  Imageclass="avatar avatar-xs"
                  Imagesrc={face14}
                  iconPosition="before"
                  Customtoggleclass="header-link dropdown-toggle no-caret border-0 border-start"
                  Menuclass="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                >
                  <li>
                    <Link
                      className="dropdown-item d-flex align-items-center"
                    ...
                    >
                      <i className="ti ti-user me-2 fs-16"></i>Profile
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      <i className="ti ti-settings me-2 fs-16"></i>Settings
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      <i className="ti ti-logout me-2 fs-16"></i>Log Out
                    </Link>
                  </li>
                </SpkDropdown>
              </div>
            ...
            {/* <!-- Start::header-element --> */}
            <SpkTooltips placement="bottom" title="Setting">
      ...
      >
        <Modal.Body>
          <div className="input-group">
            ...
            />
            <button
              className="btn btn-primary rounded-end-1"
              type="button"
              id="button-addon2"
            >
            ...
            {showa ? (
              <div
                className="card custom-card search-result w-100 position-absolute search-fix border mt-5 rounded "
                ref={searchResultRef}
              >
                <div className="card-header border-bottom">
                  <div className="card-title mb-0 text-break">
