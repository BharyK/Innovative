...
placeholder=".form-control-lg" aria-label=".form-control-lg example"/>`,t=` 
<Form>
<div className="mb-3">
...
<SpkButton variant='primary' type="submit" className="">Submit</SpkButton>
</Form>`,r=` 
...
<Form.Check type="switch" disabled defaultChecked  label="Default checked switch checkbox input"/>`,b=`
<Form.Check type="radio" className="btn-check" name="options"
id="option1" defaultChecked/>
<SpkButton className="btn btn-primary m-1">Checked</SpkButton>
<Form.Check type="radio" className="btn-check" name="options" 
id="option2" />
<SpkButton className="btn btn-primary m-1">Radio</SpkButton>
<Form.Check type="radio" className="btn-check" name="options" 
id="option3" disabled/>
<SpkButton disabled className="btn btn-primary m-1">Disabled</SpkButton>
<Form.Check type="radio" className="btn-check" name="options" 
id="option4"/>
<SpkButton className="btn btn-primary m-1">Radio</SpkButton>`,F=`
<Form.Check type="checkbox" className="btn-check" id="btn-check"/>
<SpkButton className="btn btn-primary m-1">Single toggle</SpkButton>
...
<SpkButton disabled className="btn btn-primary m-1">Disabled</SpkButton>`,h=` 
...
<span><Form.Check className="" type="radio" /></span>`,f=` 
<Form.Check 
...
className="form-check-reverse mb-3" 
type="switch" 
label="Reverse switch checkbox input" />`,k=`
<Form.Control type="checkbox" 
className="btn-check"id="btn-check-outlined"/>
<SpkButton variant='outline-primary' 
className="mb-3">Single toggle</SpkButton><br/>
<Form.Check type="checkbox"
className="btn-check" id="btn-check-2-outlined" defaultChecked />
<SpkButton variant='outline-secondary' 
className=" mb-3">Checked</SpkButton><br/>
<Form.Check type="radio" className="btn-check" 
name="options-outlined" id="success-outlined"
 defaultChecked/>
<SpkButton variant='outline-success' 
className="m-1">Checked success
radio</SpkButton>
<Form.Check type="radio" className="btn-check"
 name="options-outlined" id="danger-outlined"
/>
<SpkButton variant='outline-danger'className="m-1"
 >Danger radio</SpkButton>`,N=`
...
type="checkbox" defaultChecked id="checkebox-lg"  label="Large"/>`,y=`
...
<Form.Check type="radio" className="form-check-lg" 
 defaultChecked id="Radio-lg"  label="Large"/>`,x=`
...
<InputGroup className="mb-3">
<SpkButton variant='primary' className="" type="button"
...
<InputGroup className="mb-3">
<SpkButton variant='primary' className="" type="button">Button</SpkButton>
<SpkButton variant='primary' className="" type="button">Button</SpkButton>
<Form.Control type="text" className="" placeholder=""
...
<InputGroup className="mb-3">
<SpkButton variant='' className="btn btn-primary" type="button"
...
<Form.Control type="text" className=""
 ...
 <InputGroup className="mb-3">
<SpkButton variant='primary' type="button" className="">Action</SpkButton>
<Dropdown>
...
<Form.Control type="text" className=""
    aria-label="Text input with segmented dropdown button"/>
<SpkButton type="button" className="btn btn-primary">Action</SpkButton>
<Dropdown>
...
<InputGroup className="mb-3">
<SpkButton variant='' className="btn btn-primary" type="button">Button</SpkButton>
<Select  name="colors" options={Selectdata1} className="basic-multi-select flex-grow-1"
menuPlacement='auto' classNamePrefix="Select2" defaultValue={[Selectdata1[0]]} />
</InputGroup>
<InputGroup>
...
id="disabledRange" disabled/>`,K=`
<Form.Range  className="" min="0" max="5"
id="customRange2"/>`,X=`
<Form.Range  className="" min="0" max="5"
step="0.5" id="customRange3"/>`,_=`
...
<Form.Check className="" type="checkbox" value="" id="invalidCheck" label="Accept Policy"
    required/>
<SpkButton variant='primary' className="" type="submit">Submit</SpkButton>`,ie=`
 <div className="mb-3">
<Form.Label htmlFor="form-text" className=" fs-14 text-dark">Enter name</Form.Label>
<Form.Control type="text" className="" id="form-text" placeholder=""/>
</div>
...
<Form.Check className="" type="checkbox" value="" id="invalidCheck" label="Accept Policy"
    required/>
<SpkButton variant='primary' className="" type="submit">Submit</SpkButton>`,ne=`
...
<div className="col-12">
    <SpkButton type="submit" variant='primary' className="">Submit</SpkButton>
</div>
</Form>`,ce=`
<Row className="g-3">
<Col sm={7} className="">
...
<Row className="align-items-center">
    ...
    <Col xs="auto">
    <SpkButton type="submit" className="mb-2">
        Submit
    </SpkButton>
    </Col>
</Row>
...
<Form className="row gx-3 gy-2 align-items-center mt-0">
    ...
    <div className="col-auto">
        <SpkButton type="submit" className="btn btn-primary">Submit</SpkButton>
    </div>
</Form>`,he=`
<Row>
...
<Col md={12}>
    <SpkButton type="submit" variant='primary' className="">Sign in</SpkButton>
</Col>
</Row>`,Ce=`
...
<div className="col-12">
    <SpkButton variant='primary' type="submit" className="">Sign in</SpkButton>
</div>
</Form>`,fe=`
function FormExample() {
    ...
    return (
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <SpkButton type="submit">Submit form</SpkButton>
      </Form>
    );
  }
  
  export default FormExample;`,ke=`
...
<div className="col-12">
    <SpkButton variant='primary' className="btn " type="submit">Submit form</SpkButton>
</div>
</Form>`,Ne=`
<Form className="row g-3">
<Col md={4}>
...
<div className="col-12">
    <SpkButton className="btn btn-primary" type="submit">Submit
        form</SpkButton>
</div>
</Form>`,ye=`
 function FormExample() {
...
<div className="mb-3">
    <SpkButton variant='primary' className="btn " type="submit" disabled>Submit
        form</SpkButton>
</div>
</Form>`,ve=`
   <Form.Control
...
/>`;export{_ as $,D as A,T as B,v as C,g as D,w as E,I as F,B as G,U as H,E as I,O as J,q as K,A as L,R as M,P as N,z as O,V as P,M as Q,W as R,Y as S,H as T,J as U,j as V,Z as W,Q as X,$ as Y,K as Z,X as _,o as a,ee as a0,oe as a1,ae as a2,le as a3,te as a4,re as a5,me as a6,se as a7,ie as a8,ue as a9,be as aa,ne as ab,ce as ac,pe as ad,de as ae,Fe as af,he as ag,Ce as ah,fe as ai,ke as aj,Ne as ak,ye as al,xe as am,ve as an,a as b,l as c,s as d,t as e,r as f,m as g,n as h,e as i,c as j,p as k,d as l,u as m,N as n,y as o,x as p,h as q,i as r,C as s,f as t,k as u,b as v,F as w,L as x,S as y,G as z};
